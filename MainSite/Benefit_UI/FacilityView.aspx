<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="FacilityView.aspx.cs" Inherits="Benefit_UI_FacilityView" %>
            ...
            <div class="divWaiting">
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 16px; padding-top: 1px;"><img src="../Report_Pages/app.png"  width="20px" /> Facility List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered  text-center thead-dark" DataKeyNames="FacilityMasterId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Benefit" HeaderText="Facility" />
                                         <asp:BoundField DataField="GradeList" HeaderText="Grade List" />
