...
public partial class Benefit_UI_BenefitEntry : System.Web.UI.Page
{
    ...
    public void ButtonVisible()
    {
        ...
        {
            Response.Redirect("BenefitView.aspx");
        }
        ...
        if (Validation())
        {
            ...
            if (id ==true)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                               "alert",
                               "alert('Data Delete Successfully...');window.location ='BenefitView.aspx';",
                               true);
                Clear();
            }
        }
    ...
    public void Save()
    {
        if (Validation())
        {
            ...
            if (id > 0)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                              "alert",
                              "alert('Operation successfully done...');window.location ='BenefitView.aspx';",
                              true);
                Clear();
            }
        }
      ...
      //  aBenefitDal.DeleteBenefitMaster(loadGridView.DataKeys[rowindex][0].ToString());
         ...
         //  aBenefitDal.DeleteBenefitJobNature(loadGridView.DataKeys[rowindex][0].ToString());
            ...
            if (aBenefitDal.DeleteBenefitMaster(beneftIdHiddenField.Value))
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                                 "alert",
                                 "alert('Data Updated Successfully...');window.location ='BenefitView.aspx';",
                                 true);
                Clear();
