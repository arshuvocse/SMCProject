...
public partial class Benefit_UI_FacilityView : System.Web.UI.Page
{
    ...
    {
        DataTable dt = aBenefitDal.GetBenefitList(" where tblCompanyInfo.CompanyId IN (" + CompanyId() + ")" + GenerateParameter() + "");
    ...
    private string GenerateParameter()
    {
        ...
        {
            parameter = parameter + " AND   tblCompanyInfo.CompanyId =  '" + companyDropDownList.SelectedValue + "' ";
        }
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("FacilityEntry.aspx");
    }
