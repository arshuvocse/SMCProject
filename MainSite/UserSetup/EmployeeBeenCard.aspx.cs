...
public partial class UserSetup_EmployeeBeenCard : System.Web.UI.Page
{
    ...
    private void LoadEMPInfo()
    {
        ...
        jobCreationInfos = _userCommonDal.GetEMpInfos("  com.CompanyId IN (" + CompanyId() + ")" + GenerateParameter() + "", GenerateParameter_SP());
    ...
    private string GenerateParameter()
    {
        ...
        {
            parameter = parameter + " AND e.EmployeeStatus='" + empStatusDropDownList.SelectedItem.Text + "' ";
        }
    ...
    private string GenerateParameter_SP()
    {
        string parameter = " ";
    ...
    {
        string url = "../Report_UI/EmployeeBeenCardReportViwer.aspx?rptType=" + EmpInfoId;
   ...
   <h3>Employee Information List	</h3>
    ...
    {
        Response.Redirect("EmployeeBeenCard.aspx");
    }
