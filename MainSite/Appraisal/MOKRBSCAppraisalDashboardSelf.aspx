<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MOKRBSCAppraisalDashboardSelf.aspx.cs" Inherits="Appraisal_MOKRBSCAppraisalDashboardSelf" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        ...
        /* Keep dropdown options readable (avoid inheriting selected color). */
        select.status-red option,
        select.status-green option,
        select.status-yellow option {
    ...
    <ItemTemplate>
        <asp:Label runat="server" ID="txtInitiatives"  Width="250px" Text='<%#Eval("Initiatives") %>'></asp:Label>
                                            ...
                                            TargetControlID="txtDeadLine" />
                                                             ...
                                                             <asp:TemplateField runat="server" Visible="False" HeaderText="Results
(Year End)">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server"  Width="80px" ID="txtResultYearEnd" CssClass="form-control  form-control-sm" Text='<%#Eval("ResultYearEnd") %>'></asp:TextBox>
    ...
    <ItemTemplate>
        ...
        <asp:DropDownList   Width="110px"  runat="server" ID="txtMidStatus" CssClass="form-control  form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="txtMidStatus_SelectedIndexChanged">
         ...
         <asp:LinkButton  runat="server" Visible="False"  Width="100px"  OnClick="lbMidStatus_OnClick" CssClass="btn btn-info" Text="Update" ID="lbMidStatus" ></asp:LinkButton>

    </ItemTemplate>
</asp:TemplateField>

                                                                                                                                                                                                                                                                                        <asp:TemplateField HeaderText="Maximum<br/>Mid-Year<br/>Marking" runat="server" >
    <ItemTemplate>
        <asp:Label runat="server"      ID="lblAutoCalculation" Text='<%#Eval("AutoCalculation") %>'></asp:Label>
    </ItemTemplate>
</asp:TemplateField>                                                                        

                                                             <asp:TemplateField HeaderText="Mid-Year<br/>Marking">
         <ItemTemplate>
             <asp:TextBox  runat="server" ID="txtselfMark" AutoPostBack="True" OnTextChanged="txtselfMark_OnTextChanged"     TextMode="Number"  onkeypress="return isNumeric(event);"  CssClass="form-control  form-control-sm"  Text='<%#Eval("SelfMark") %>'></asp:TextBox>
             ...
             <br />
              <asp:Label runat="server" Font-Bold="true"   ForeColor="#cc6600" ID="lblAutoCalculationPer"      Text='<%#Eval("AutoCalculationPer") %>'></asp:Label>
         ...
         <FooterTemplate>
             <asp:Label ID="lblTotalMark" CssClass="form-control  form-control-sm" runat="server" /> <br /> <asp:Label     ID="lblTotalMarkAchiv"  Font-Bold="true" style="font-size:16px;" ForeColor="#cc6600"   runat="server" /><br /> <asp:Label ID="lblMarkAchiv"     Font-Bold="true" ForeColor="#cc0000" style="font-size:16px;"   runat="server" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Self Assesment">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="txtComment" CssClass="form-control resizable-textbox" TextMode="MultiLine" Rows="2" Text='<%#Eval("CommentsFunc") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div id="gridContainerbeh" style="height: auto; overflow: auto; width: auto;">
                                                ...
                                                <asp:GridView runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%" ID="gv_AppraisalPartB" DataKeyNames="BSCAppraisalSelfBehaveId"  CssClass="table table-bordered text-center thead-dark gridDatatable">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="SelfScore" AutoPostBack="True" OnTextChanged="SelfScore_OnTextChanged" CssClass="form-control  form-control-sm" TextMode="Number" onkeypress="return isNumeric(event);" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fi01lseljj2ssss12sEsxtender2" runat="server" Enabled="True"
                                                        ...
                                                        <asp:TemplateField HeaderText="Self Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ReadOnly="True" ID="SelfScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                    ...
                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fil2ssss12sEsxsdtender2" runat="server" Enabled="True"
TargetControlID="SelfScore" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                            <FooterStyle HorizontalAlign="Right" />
                                                            <FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supervisor Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" AutoPostBack="True" OnTextChanged="SupervisorScore_OnTextChanged" ID="SupervisorScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SupervisorScore") %>'></asp:TextBox>
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fil21SusspervisorScore001" runat="server" Enabled="True"
TargetControlID="SupervisorScore" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
    ...
    <script type="text/javascript">
        ...
        function normalizeMidYearInput(input) {
            if (input.value === 'Ongoing') {
                input.value = 'On Track';
            }
            if (input.value === 'Not Completed') {
                input.value = 'Behind';
            }
        }

        function setMidYearStatusColor(dropdown) {
            const v = (dropdown.value || '').trim();  // Value
            const t = (dropdown.options[dropdown.selectedIndex]?.text || '').trim(); // Text
        ...
        function isMidYearMarkDisabled(dropdown) {
            const v = (dropdown.value || '').trim();
            const t = (dropdown.options[dropdown.selectedIndex] && dropdown.options[dropdown.selectedIndex].text)
                ? dropdown.options[dropdown.selectedIndex].text.trim()
                : '';

            return v === 'Not Started' || t === 'Not Started' || v === 'Not Relevant' || t === 'Not Relevant';
        }

        function setMidYearInputsState(dropdown) {
            const row = dropdown.closest('tr');
            if (!row) return;

            const mark = row.querySelector('input[id*="txtselfMark"]');
            const disableMark = isMidYearMarkDisabled(dropdown);

            if (mark) {
                mark.readOnly = disableMark;
                if (disableMark) {
                    mark.value = '';
                }
            }
            // Keep Self Assessment enabled even when status is Not Started.
        }

        function initializeMidYearColors() {
            const dropdowns = document.querySelectorAll('select[id*="txtMidStatus"]');
            const inputs = document.querySelectorAll('input[id*="txtMidStatus"]');

            dropdowns.forEach(function (ddl) {
                normalizeMidYearOptions(ddl);
                setMidYearStatusColor(ddl);
                setMidYearInputsState(ddl);
                ...
                ddl.addEventListener('change', function () {
                    ...
                    setMidYearInputsState(this);
                });
            });

            inputs.forEach(function (input) {
                normalizeMidYearInput(input);
            });
        }
        // first load
