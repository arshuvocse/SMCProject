<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="AppraisalDashboard.aspx.cs" Inherits="Appraisal_AppraisalDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpFormBody" runat="Server">
    ...
    <ItemTemplate>
        <asp:Label ID="Approval" runat="server" 
            Text='<%# Eval("ActionStatusAppraisal") %>'></asp:Label>
        ...
        box-shadow: 0px 3px 6px rgba(0,0,0,0.2);
                                        ...
                                        <div class="col-md-12">
                                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto;">
                                                ...
                                                <asp:GridView runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%" ID="gv_AppraisalFunc" CssClass="table table-bordered text-center thead-dark gridDatatable" DataKeyNames="MidYearStatus,AppraisalSelfFucAreaId">
                                            ...
                                            TargetControlID="txtDeadLine" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Status">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList Visible="false"  runat="server" ID="txtMidStatus" CssClass="form-control  form-control-sm">
                                                                    <asp:ListItem Value="Not Started">Not Started</asp:ListItem>
                                                                    <asp:ListItem Value="In Progress">In Progress</asp:ListItem>
                                                                    <asp:ListItem Value="Completed">Completed</asp:ListItem>
                                                                </asp:DropDownList>
                                                                  <asp:TextBox ReadOnly="true" runat="server" ID="txtMidStatusNew" CssClass="form-control  form-control-sm" Text='<%#Eval("MidYearStatus") %>'></asp:TextBox> 
                                                                
                                                              <div style="display:none">
                                                                     <asp:LinkButton Visible="false" runat="server" OnClick="lbMidStatus_OnClick" CssClass="btn btn-info" Text="Update" ID="lbMidStatus" ></asp:LinkButton>
                                                              </div>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                             <asp:TemplateField HeaderText="Results (End Year)">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="SelfScore" AutoPostBack="True" OnTextChanged="SelfScore_OnTextChanged" CssClass="form-control  form-control-sm" TextMode="Number" onkeypress="return isNumeric(event);" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fi01l2ssss12sEswqextender2" runat="server" Enabled="True"
                                                        ...
                                                        <asp:TemplateField HeaderText="Self Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ReadOnly="True" ID="SelfScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fiasd01l2ssss12sEsxtender2" runat="server" Enabled="True"
TargetControlID="SelfScore" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                            <FooterStyle HorizontalAlign="Right" />
                                                            <FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supervisor Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" AutoPostBack="True" OnTextChanged="SupervisorScore_OnTextChanged" ID="SupervisorScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SupervisorScore") %>'></asp:TextBox>
                                                                                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fil21S3423upervisorScore001" runat="server" Enabled="True"
