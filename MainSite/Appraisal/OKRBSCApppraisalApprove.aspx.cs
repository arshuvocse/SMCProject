...
public partial class Appraisal_OKRBSCApppraisalApprove : System.Web.UI.Page
{
    ...
    protected void btnAppraisalFuncSUPSave_OnClick(object sender, EventArgs e)
    {
        if (ValidationFunCSUp() == true)
        {
            ...
            for (int i = 0; i < gv_AppraisalFuncSUP.Rows.Count; i++)
            {
                ...
                TextBox txtWeight = (TextBox)gv_AppraisalFuncSUP.Rows[i].FindControl("txtWeight");
                TextBox txtDeadLine = (TextBox)gv_AppraisalFuncSUP.Rows[i].FindControl("txtDeadLine");
                Label lblSelfAssessment = (Label)gv_AppraisalFuncSUP.Rows[i].FindControl("lblSelfAssessment");
                TextBox txtSupervisorAssessment = (TextBox)gv_AppraisalFuncSUP.Rows[i].FindControl("txtSupervisorAssessment");
                if (hdnDimensionStr.Value != "" )
                {
                    ...
                    area.SelfAssessment = lblSelfAssessment.Text.Trim().ToString();
                    area.SupervisorAssessment = txtSupervisorAssessment.Text.Trim().ToString();
