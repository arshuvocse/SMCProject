...
public partial class Appraisal_KpiDeadlineSetupListView : System.Web.UI.Page
{
...
//
               // ViewState["EmpSetup"] = dtForAll;
                ...
                DataTable dtForAll = _jdDal.GetJdDetailsForView(mid);
                gv_allocateEmp.DataSource = dtForAll;
    ...
    public bool Validation()
    {
        ...
        if (
            _jdDal.CheckPreviousKpiDeadline(Convert.ToInt32(ddlCompany.SelectedValue),
    ...
    {
        bool result = _jdDal.DeleteKpiSetup(Convert.ToInt32(hid_KpiMasrerId.Value), Session["LoginName"].ToString());
    ...
    protected void Button1_OnClick(object sender, EventArgs e)
    {
        ...
        DataTable dt = _jdDal.GetEmployeeForKpiSetUpNew((ddlCompany.SelectedValue.ToString()), deadLine, remarks,Parameter());
        gv_allocateEmp.DataSource = dt;
        gv_allocateEmp.DataBind();
