...
public partial class Appraisal_KpiDeadlineSetup : System.Web.UI.Page
{
...
//                }
    ...
    public string Parameter()
    {
        ...
        {
            param = param + " and  A.EmpInfoId not in  (select dtl.EmpinfoId from tblKpiDeadlineMaster mas inner join tblKPIDeadLineDetails dtl on mas.KPIDeadLineMasterId=dtl.KPIDeadLineMasterId where mas.KPIDeadLineMasterId= '" + hid_KpiMasrerId.Value + "' )";
        }
    ...
    protected void btn_Save_OnClick(object sender, EventArgs e)
    {
        ...
        if (Validation() == true)
        {
            ...
            DataTable aTable =
                _jdDal.DeleteValidattionForEffectiveDate( (ddlCompany.SelectedValue),  (ddlFinancialYear.SelectedValue));
                ...
                if (aDetailses.Count > 0)
                {
                    ...
                    if (result == true)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                            "alert",
                            "alert('Operation Successful...');window.location ='KpiSetupList.aspx';",
                            true);
    ...
    {
        Response.Redirect("KpiDeadlineSetup.aspx");
    }
    ...
    protected void Button1_OnClick(object sender, EventArgs e)
    {
        ...
        DataTable dt = _jdDal.GetEmployeeForKpiSetUpNew_ST((ddlCompany.SelectedValue.ToString()), deadLine, remarks, Parameter());
        gv_allocateEmp.DataSource = dt;
        gv_allocateEmp.DataBind();
