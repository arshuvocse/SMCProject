...
public partial class Appraisal_BSCOKRInformationView : System.Web.UI.Page
{
    private CommonDataLoadDAL _commonDataLoad = new CommonDataLoadDAL();
    private BSCKPIInformationViewDAL _aFincDal = new BSCKPIInformationViewDAL();
        ...
        try
        {
            ...
            if (dtuserpermission.Rows.Count > 0)
            {
                    ...
                    dtuserpermission.Rows[0]["UserTypeId"].ToString() != "4")
                {
                    ...
                    gv_JdBoard.Columns[gv_JdBoard.Columns.Count - 4].Visible =
    ...
    protected void btn_eview_OnClick(object sender, EventArgs e)
    {
        ...
        HiddenField EmpInfoId = (HiddenField)gv_JdBoard.Rows[rowID].FindControl("EmpInfoId");
        HiddenField FinancialYearId = (HiddenField)gv_JdBoard.Rows[rowID].FindControl("FinancialYearId");   Label OptionInfo = (Label)gv_JdBoard.Rows[rowID].FindControl("OptionInfo");
    ...
    protected void btn_print_OnClick(object sender, EventArgs e)
    {
        ...
        string url = "../Report_UI/BSCKPIInformationReportViewer.aspx?EmpInfoId=" + EmpInfoId.Value + "&financialYearId=" + FinancialYearId.Value + "&M=" + OptionInfo.Text;
    ...
    protected void SearchButton_OnClick(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = _aFincDal.GetAppraisalByKpiPermission_New__BSCOKR(ddlCompany.SelectedValue.ToString(), Parameter(), " and  tblBSCAppraisalSelfAppLog.Version=CELog.MaxVer " + Parameter_JJJ());
            ...
            {
                DataTable dt3 = _aFincDal.GetAppraisalByKpiPermission_New__(ddlCompany.SelectedValue.ToString(), Parameter2(), " and  tblBSCAppraisalSelfAppLog.Version=CELog.MaxVer " + Parameter_JJJ());
