...
public partial class Appraisal_HRDeadlineExtendedEntry : System.Web.UI.Page
{
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("HRDeadlineExtendedView.aspx");
    }
    ...
    protected void ddlCompany_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        using (DataTable dtemp = _commonDataLoad.GetEmpDDLAActiveOnlyView(ddlCompany.SelectedValue.ToString())
            )
        {
            ...
            if (aDetailses.Count > 0)
            {
                ...
                if (result == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Operation Successful...');window.location ='HRDeadlineExtendedView.aspx';",
                        true);
