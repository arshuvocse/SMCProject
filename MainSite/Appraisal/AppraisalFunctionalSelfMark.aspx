<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true"  CodeFile="AppraisalFunctionalSelfMark.aspx.cs" Inherits="Appraisal_AppraisalFunctionalSelfMark" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Appraisal Functional Part</h1>
                        </div>
...
.title-widget::before {
  ...
  <td style="width: 20%; padding: 10px;" class="tblTHColorChang" >Place</td>
                            ...
                            <br/>
                                 <h2 class="blue title-widget" style="color:#2196F3; text-shadow:  0 0 2px black;"> A.FUNCTIONAL AREA</h2>
                            <hr/>
                            <asp:GridView runat="server"  ShowFooter="true" AutoGenerateColumns="False" Width="100%" ID="gv_AppraisalFunc" CssClass="table table-bordered text-center thead-dark gridDatatable" DataKeyNames="MidYearStatus,AppraisalSelfFucAreaId" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Key Performance Indicator">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="txtKpi" Width="400px"     Text='<%#Eval("KpiInfo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
