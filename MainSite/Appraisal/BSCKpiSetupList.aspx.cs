...
public partial class Appraisal_BSCKpiSetupList : System.Web.UI.Page
{
    ...
    BSCKPISETUPListDAL aEmployeeRequsitionDal = new BSCKPISETUPListDAL();
    ...
    protected void btn_edit_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("BSCKpiDeadlineSetup.aspx?masterId=" + mastrId.Value + "");
    }
    ...
    protected void SearchButton_OnClick(object sender, EventArgs e)
    {
        if (companyDropDownList.SelectedValue!="")
        {
            DataTable dt = aEmployeeRequsitionDal.GetKpiSetupList(" And c.CompanyId IN (" + CompanyId() + ") " + GenerateParameter() + "");
            if (dt.Rows.Count > 0)
            {
                gv_kpiSetup.DataSource = dt;
                gv_kpiSetup.DataBind();
    ...
    private string GenerateParameter()
    {
        ...
        //parameter = parameter + " AND   OptionInfo='BSC'  ";
        if (companyDropDownList.SelectedValue != "")
        {
