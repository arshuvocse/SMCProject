<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="BSCKpiDeadlineSetup.aspx.cs" Inherits="Appraisal_BSCKpiDeadlineSetup" %>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class="col-md-2">
     <div class="form-group">
         <label for="ddl_options">Operaton</label>
                            ...
                            <fieldset class="for-panel">
                                ...
                                <asp:GridView ID="gv_allocateEmp" Width="100%" CssClass="table table-bordered text-center thead-dark" AutoGenerateColumns="false" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Dead Line"  Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Oepration">
                                            <ItemTemplate>
