...
public partial class Appraisal_DeadlineExtendedEntryView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  UserPersmissionValidation();
            ...
            DataTable dt = _jdDal.GetDeadlineExtendedEntryList(" AND tblCompanyInfo.CompanyId IN (" + CompanyId() + ")");
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("DeadlineExtendedEntry.aspx");
    }
    ...
    protected void btn_edit_OnClick(object sender, EventArgs e)
    {
        ...
        HiddenField mastrId = (HiddenField)gv_kpiSetup.Rows[rowID].FindControl("DeadlineExtensionRequestId");
