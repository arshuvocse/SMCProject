...
public partial class Appraisal_AppraisalDeadlineSetupMailSend : System.Web.UI.Page
{
                ...
                if (VallliMail())
                {
                    ...
                    if (ChkBoxRows.Checked)
                    {
                        ...
                        mail.Body =
                            ...
                            WebUtility.HtmlDecode(txt_Remarks.Text)
                            +
                             " Your Dead Line: " + txt_DeadLine.Text+
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                            "alert",
                            "alert('Sent Successfully...! ');window.location ='AppaisalSetupList.aspx';",
                            true);
