...
public partial class Appraisal_KPIApppraisalChangeMarkforHR : System.Web.UI.Page
{
    private CommonDataLoadDAL _commonDataLoad = new CommonDataLoadDAL();
    private HRIS_SMCEntities _hrEntities = new HRIS_SMCEntities();
    private AppraisalFunctionalPartHRDAL _appPartA = new AppraisalFunctionalPartHRDAL();
    ...
    {
        DataTable DTSupp = _appDashboard.GetAppraisalDashboardHRNew(empId, finYear);
...
");
                                ...
                                ScriptManager.RegisterStartupScript(this, this.GetType(),
                                    "alert",
                                    "alert('Operation Successfully...');window.location ='ApppraisalApprove.aspx';",
                                    true);
...
");
    ...
    protected void btn_Save1_OnClick(object sender, EventArgs e)
    {
        ...
        if (confirmstatus)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(),
                       "alert",
                       "alert('Operation Successful...');window.location ='ApppraisalApprove.aspx';",
                       true);
        }
        else
        {
