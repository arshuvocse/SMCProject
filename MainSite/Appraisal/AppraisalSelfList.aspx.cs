...
public partial class Appraisal_AppraisalSelfList : System.Web.UI.Page
{
    ...
    protected void btn_eview_OnClick(object sender, EventArgs e)
    {
        ...
        if (radOp.Items[0].Selected)
        {
            ...
            Response.Redirect("AppraisalSelfFunctionalViewDetails.aspx?EmpInfoId=" + EmpInfoId.Value + "&financialYearId=" + FinancialYearId.Value + "");
        ...
        else
        {
            ...
            Response.Redirect("AppraisalSelfFunctionalViewDetailsSupp.aspx?EmpInfoId=" + EmpInfoId.Value + "&financialYearId=" + FinancialYearId.Value + "");
    ...
    protected void btn_print_OnClick(object sender, EventArgs e)
    {
        ...
        string url = "../Report_UI/KPIInformationReportViewer.aspx?EmpInfoId=" + EmpInfoId.Value + "&financialYearId=" + FinancialYearDropDownList.SelectedValue;
        ...
        if (FinancialYearDropDownList.SelectedValue != "")
        {
            ...
            if (selectedValue == "Own")
            {
                ...
                DataTable dt = _aFincDal.GetAppraisalByKpiPermissionsss(Session["EmpInfoId"].ToString(),
                    FinancialYearDropDownList.SelectedItem.Text, "  and   tblAppraisalSelfAppLog.Version=CELog.MaxVer ", "  ");
                if (dt.Rows.Count > 0)
                {
