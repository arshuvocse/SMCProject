<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="KPIApppraisalChangeMarkforHR.aspx.cs" Inherits="Appraisal_KPIApppraisalChangeMarkforHR" %>
                                                        ...
                                                        <asp:TemplateField HeaderText="Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="SelfScore" AutoPostBack="True" OnTextChanged="SelfScore_OnTextChanged" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fisasassdasdsasasare001sad" runat="server" Enabled="True"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div id="gridContainer1SUP" style="height: auto; overflow: auto; width: auto;">
                                                ...
                                                <asp:GridView runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%" ID="gv_AppraisalFuncSUP" CssClass="AddToListCssTable" OnPreRender="gv_DocumentUpload_PreRender" DataKeyNames="AppraisalSelfFucAreaId">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Status">
                                                            <ItemTemplate>
                                                               ...
                                                               <%-- <asp:DropDownList Enabled="False" runat="server" ID="txtMidStatus" CssClass="form-control  form-control-sm">
                                                                    <asp:ListItem Value="Not Started">Not Started</asp:ListItem>
                                                                    <asp:ListItem Value="In Progress">In Progress</asp:ListItem>
                                                                    <asp:ListItem Value="Completed">Completed</asp:ListItem>
                                                                </asp:DropDownList>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Marking" runat="server" >
                                                            <ItemTemplate>
                                                                <asp:TextBox ReadOnly="true" runat="server" ID="txtResult" CssClass="form-control  form-control-sm"  Text='<%#Eval("ResultYearEnd") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Self-Mark">
                                                            <ItemTemplate>
                                                                <asp:TextBox AutoPostBack="True" OnTextChanged="txtsupselfMark_OnTextChanged" runat="server" ReadOnly="True" ID="txtselfMark" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SelfMark") %>'></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Self Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ReadOnly="True" ID="SelfScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SelfScore") %>'></asp:TextBox>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="sad" runat="server" Enabled="True"
TargetControlID="SelfScore" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supervisor Score">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" AutoPostBack="True" OnTextChanged="SupervisorScore_OnTextChanged" ID="SupervisorScore" CssClass="form-control  form-control-sm" TextMode="Number" Text='<%#Eval("SupervisorScore") %>'></asp:TextBox>
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    <cc1:FilteredTextBoxExtender ID="Fil21SasdupervasdisorScore0asd01" runat="server" Enabled="True"
