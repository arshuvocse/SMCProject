...
public partial class Appraisal_AppraisalDeadlineSetup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["masterId"]))
            {
                ...
                DataTable dt = _jdDal.GetAppraisalSetupByMaster(mid);
                ...
                DataTable dt2 = _AppraisalSetupListDAL.GetAppraisalSetupDetailsByMaster(mid);
    ...
    public void ButtonVisible()
    {
        ...
        {
            Response.Redirect("AppaisalSetupList.aspx");
        }
    ...
    protected void btn_Save_OnClick(object sender, EventArgs e)
    {
        ...
        if (Validation() == true)
        {
            ...
            DataTable aTable =
                _jdDal.DeleteValidattionAppraisalDeclaration((ddlCompany.SelectedValue), (ddlFinancialYear.SelectedValue));
            ...
            else
            {
                ...
                aMaster.AppraisalDeadLineMasterId = hid_KpiMasrerId.Value == ""
                    ? 0
    ...
    protected void delButton_OnClick(object sender, EventArgs e)
    {
        ...
        DataTable aTable =
            _jdDal.CheckAppraisalSetpExistMulti(Emp, FinancialYear);
        if (aTable.Rows.Count > 0)
        {
        ...
        else
        {
            ...
            bool result = _jdDal.DeleteAppraisalSetup(Convert.ToInt32(hid_KpiMasrerId.Value),
    ...
    protected void deleteImageButtonDirectlySupervices_OnClick(object sender, ImageClickEventArgs e)
    {
        ...
        DataTable aTable =
            _jdDal.CheckAppraisalExist(empInfoId.Value, ddlFinancialYear.SelectedValue);
        if (aTable.Rows.Count > 0)
        {
            AlertMessageBoxShow("Can Not be Deleted...");
        }
