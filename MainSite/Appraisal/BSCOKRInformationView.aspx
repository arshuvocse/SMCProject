<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BSCOKRInformationView.aspx.cs" Inherits="Appraisal_BSCOKRInformationView" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png" width="20px"  />BSC/OKR Information</h1>
                        </div>
  ...
  <asp:LinkButton runat="server" ID="SearchButton" OnClick="SearchButton_OnClick"   CssClass="btn btnMyDesignSearch   btn-sm"><span aria-hidden="true" class="fa fa-search-plus"></span>  &nbsp; Search Information </asp:LinkButton>
                                   ...
                                   <div class="col-2">
                                    <div class="form-group" style="margin-top: 18px;">
                                     <asp:LinkButton Visible="false" ID="btnExportToExcel" runat="server"  CssClass="btnexcel  pull-right" OnClick="btnExportToExcel_Click" ><i class="fa fa-file-excel-o"></i> Export To Excel</asp:LinkButton>
                                     </div>
                                </div>
                                 </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfAppraisalMasterId" runat="server" Value='<%#Eval("BSCAppraisalMasterId") %>' />
                                            <asp:HiddenField ID="hfAppraisalSelfMasterId" runat="server" Value='<%#Eval("BSCAppraisalSelfMasterId") %>' />
                                   ...
                                   <%--   <asp:TemplateField HeaderText="Employee Info">
                                    ...
                                    <asp:TemplateField HeaderText="KPI Approval Status">
                                        <ItemTemplate>
                                            <asp:Label ID="ActionStatus" runat="server"   Text='<%#Eval("ActionStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                         <asp:TemplateField HeaderText=" KPI Awaiting Employee">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Reset Approval Person">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="btn_KPI"  OnClick="btn_KPI_OnClick" Text='<%#Eval("OptionInfo") %>' CssClass="btn btn-xs btn-KPI" > 
                                            </asp:LinkButton>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="TotalMarks" HeaderText="Appraisal Score" />
