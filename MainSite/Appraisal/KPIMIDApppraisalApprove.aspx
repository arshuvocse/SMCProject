<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="KPIMIDApppraisalApprove.aspx.cs" Inherits="Appraisal_KPIMIDApppraisalApprove" %>
            ...
            <div class="page-heading">
                <div class="page-heading__container">
                    <h1 class="title" style="font-size: 18px; padding-top: 0px;">
                        ...
                        KPI Mid-Year Supervisor Marking</h1>
                </div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Score">
                                                            <ItemTemplate>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="Fisasdasasdasdasare001sad" runat="server" Enabled="True"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div id="gridContainer1SUP" style="height: auto; overflow: auto; width: auto;">
                                                ...
                                                <asp:GridView runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%" ID="gv_AppraisalFuncSUP" OnRowDataBound="gv_AppraisalFuncSUP_RowDataBound" CssClass="AddToListCssTable" OnPreRender="gv_DocumentUpload_PreRender" DataKeyNames="AppraisalSelfFucAreaId">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="KPI Mid-Year Status">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:DropDownList Enabled="false" Width="110px" runat="server" ID="txtMidStatus" CssClass="form-control  form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="txtMidStatus_SelectedIndexChanged">
                                                        ...
                                                        <asp:TemplateField HeaderText="Self Assesment">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ReadOnly="True" ID="txtComment" CssClass="form-control  form-control-sm resizable-textbox" TextMode="MultiLine" Rows="2" Text='<%#Eval("Comments") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supervisor Assesment">
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="txtSupervisorComment" CssClass="form-control  form-control-sm resizable-textbox" TextMode="MultiLine" Rows="2" Text='<%#Eval("SupervisorComments") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Self Score">
                                                            <ItemTemplate>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="Fiaasdsasasdasdasare001sad" runat="server" Enabled="True"
                                                                    TargetControlID="SelfScore" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mid-Year Supervisor Score">
                                                            <ItemTemplate>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="adasFil21SuasdpervasdisorScore001" runat="server" Enabled="True"
