...
public partial class Appraisal_OKRDeadlineSetup : System.Web.UI.Page
{
...
//
    ...
    public void ButtonVisible()
    {
        ...
        {
            Response.Redirect("OKRKpiSetupList.aspx");
        }
    ...
    public string Parameter()
    {
        ...
        {
            param = param + " and  A.EmpInfoId not in  (select dtl.EmpinfoId from tblBSCKpiDeadlineMaster mas inner join tblBSCKPIDeadLineDetails dtl on mas.KPIDeadLineMasterId=dtl.KPIDeadLineMasterId where mas.FinancialYearId= '" + ddlFinancialYear.SelectedValue + "' )";
        }
        else
        {
            param = param + " and  A.EmpInfoId not in  (select dtl.EmpinfoId from tblBSCKpiDeadlineMaster mas inner join tblBSCKPIDeadLineDetails dtl on mas.KPIDeadLineMasterId=dtl.KPIDeadLineMasterId where mas.FinancialYearId= '" + ddlFinancialYear.SelectedValue + "' )";
                ...
                if (aDetailses.Count > 0)
                {
                    ...
                    if (result == true)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                            "alert",
                            "alert('Operation Successful...');window.location ='OKRKpiSetupList.aspx';",
                            true);
