<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="KPIMidYearSetup.aspx.cs" Inherits="Appraisal_KPIMidYearSetup" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png" width="20px"  />KPI Mid-Year Setup</h1>
                        </div>
                        ...
                        <asp:ListItem Text="Stop Mid Year KPI" Value="Stop" />
                            ...
                            <div class="row">
                             <div class="col-md-2">
                                  ...
                                  <asp:Button runat="server" ID="btnSubmit" OnClick="btnSubmit_Click" ToolTip="Submit" Text="Submit" CssClass="btn btn-success w-100" />
                                 </div>
                                </div>
                         ...
                         var table = $('#cpFormBody_gv_kpiSetup').DataTable(
                              {
                               ...
                               ,
                                      filename: 'Appraisal Declaration and Deadline List',
                                      title: 'SMC',
                                      messageTop: 'Appraisal Declaration and Deadline List',
                                      exportOptions: {
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="AppraisalDeadLineMasterId" runat="server" Value='<%#Eval("AppraisalDeadLineMasterId") %>' />
                                    ...
                                    <asp:TemplateField HeaderText="Company">
                                        <ItemTemplate>
                                            <asp:Label ID="CompanyName" runat="server" Text='<%#Eval("ShortName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Declaration Date">
                                        <ItemTemplate>
                                            <asp:Label ID="DeclarationDate" runat="server" DataFormatString="{0:dd-MMM-yyyy}" Text='<%#Eval("DeclarationDate") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Created By">
                                        <ItemTemplate>
                                            <asp:Label ID="EntryBy" runat="server" Text='<%#Eval("EntryBy") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Created Date">
                                        <ItemTemplate>
                                            <asp:Label ID="EntryDate" runat="server" DataFormatString="{0:dd-MMM-yyyy}" Text='<%#Eval("EntryDate") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="btn_Remove" OnClick="btn_Remove_OnClick"><img src="../Assets/img/delete.png" /></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
