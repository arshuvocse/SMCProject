...
public partial class Appraisal_OKRBSCAppaisalSetupList : System.Web.UI.Page
{
    ...
    BSCKPISETUPAppraisalListDAL aEmployeeRequsitionDal = new BSCKPISETUPAppraisalListDAL();
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("BSCOKRAppraisalDeadlineSetup.aspx");
    }
    ...
    protected void btn_edit_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("BSCOKRAppraisalDeadlineSetup.aspx?masterId=" + mastrId.Value + "");
    }
    ...
    protected void btn_View_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("KpiDeadlineSetupListView.aspx?masterId=" + mastrId.Value + "");
    }
    ...
    protected void SearchButton_OnClick(object sender, EventArgs e)
    {
        if (companyDropDownList.SelectedValue!="")
        {
            DataTable dt = aEmployeeRequsitionDal.GetKpiSetupListDeadline(" And c.CompanyId IN (" + CompanyId() + ") " + GenerateParameter() + "");
            if (dt.Rows.Count > 0)
            {
                gv_kpiSetup.DataSource = dt;
                gv_kpiSetup.DataBind();
    ...
    private string GenerateParameter()
    {
        ...
        //parameter = parameter + " AND   OptionInfo='OKR'  ";
