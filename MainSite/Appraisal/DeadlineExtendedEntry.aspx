<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DeadlineExtendedEntry.aspx.cs" Inherits="Appraisal_DeadlineExtendedEntry" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        ...
                        <div class="page-heading__container float-right d-none d-sm-block">
                            <asp:Button ID="detailsViewButton" Text="View List" OnClick="detailsViewButton_OnClick" Visible="False" CssClass="btn btn-sm btn-outline-secondary " runat="server" />
                        </div>
                    </div>
...
.title-widget::before {
    ...
    width: 5px;
                            ...
                            <div class="row">
                                   <div class="col-md-2" runat="server" id="comp" Visible="False">
