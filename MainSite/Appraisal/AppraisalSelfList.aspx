<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="AppraisalSelfList.aspx.cs" Inherits="Appraisal_AppraisalSelfList" %>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton CssClass="btn btn-sm btnMyDesignSearch" runat="server" ID="btn_edit" OnClick="btn_edit_OnClick">
                                                      <i class="fa fa-check-circle"></i>&nbsp; Set KPI
                                            </asp:LinkButton>
                                            &nbsp;	
                                     &nbsp;	
                                     ...
                                     &nbsp;	
                                            ...
                                            &nbsp;	
                                     &nbsp;	
                                              <asp:Label ID="lblExpiere"  Visible='<%# Eval("KPIActionStatus").ToString() != "Approved" %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
