...
public partial class Appraisal_BSCOKRSelfKPI : System.Web.UI.Page
{
    ...
    public static object SaveData(List<FuncData> FuncData, List<PartBData> PartBData, string actionType, string Comments, string Frm)
    {
        ...
        if (HttpContext.Current.Session["EmpInfoId"].ToString() != HttpContext.Current.Session["O_ApproverEmpInfoId"].ToString())
        {

            HttpContext.Current.Response.Redirect("../Default.aspx");

        }
        HttpContext.Current.Session["O_ApproverEmpInfoId"] = null;
        bool _Result = false;
        string _msg = "";
        BSCAppraisalFunctionalPartDAL _appPartA = new BSCAppraisalFunctionalPartDAL();
