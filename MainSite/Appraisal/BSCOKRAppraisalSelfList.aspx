<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="BSCOKRAppraisalSelfList.aspx.cs" Inherits="Appraisal_BSCOKRAppraisalSelfList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpFormBody" runat="Server">
    ...
    <div class="content">
  	 ...
  	 <i class="fa fa-check-circle"></i>&nbsp; Create Information
                                            </asp:LinkButton>
                                            &nbsp;	
                                     &nbsp;	
