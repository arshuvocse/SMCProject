<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="AppraisalOwnMarkSupApproveView.aspx.cs" Inherits="Appraisal_AppraisalOwnMarkSupApproveView" %>
                ...
                <div class="container-fluid" >
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            Comments :
                            <asp:TextBox runat="server" ID="remarks" Width="400px" TextMode="MultiLine" class="form-control form-control-sm"></asp:TextBox>

                            <br/> <br/> <br/>
                            <asp:Button runat="server" OnClick="Approve_OnClickClick" ID="Approve" CssClass="btn btn-success" Text="Approve"/>
                             <asp:Button runat="server" OnClick="Return_OnClick" ID="Return" CssClass="btn btn-success" Text="Return"/>
