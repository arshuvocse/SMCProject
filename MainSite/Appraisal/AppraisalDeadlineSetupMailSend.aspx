<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="AppraisalDeadlineSetupMailSend.aspx.cs" Inherits="Appraisal_AppraisalDeadlineSetupMailSend" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">   
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Assets/img/gmail.png" />  Appraisal Declaration and Deadline Notification </h1>
                        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlFinancialYear" Enabled="False" AutoPostBack="true" OnSelectedIndexChanged="ddlFinancialYear_OnSelectedIndexChanged" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                         <label>Subject</label> &nbsp;<label style="color: #a52a2a">*</label>
                                        <asp:TextBox ID="subjectTextBox"  Rows="2" TextMode="MultiLine" runat="server"  CssClass="form-control "></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="DeclarationTextBox" ReadOnly="True" runat="server" CssClass="form-control form-control-sm"   OnTextChanged="DeclarationTextBox_OnTextChanged"  AutoPostBack="True"  ></asp:TextBox>
                                         

                                    </div>

                                </div>
                                <div class="col-md-1.5" style="margin-top: 17px;" runat="server" Visible="False"   >
                                    <div class="form-group" >
                        ...
                        <asp:GridView ID="gv_allocateEmp" Width="100%" CssClass="table table-bordered text-center thead-dark" AutoGenerateColumns="false" runat="server">
                            ...
                            <%--    <asp:TemplateField HeaderText="Division">
                                 ...
                                 <asp:TemplateField HeaderText="Mail ID">
                                    <ItemTemplate>
                                        <asp:Label ID="txt_MAilID" runat="server"   Text='<%#Eval("OfficialEmail") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <%-- <asp:TemplateField HeaderText="Total Employee">
                                    <ItemTemplate>
                                        <asp:Label ID="TotalEmployee" runat="server"   Text='<%#Eval("TotalEmployee") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            ...
                            <div class="row" style="padding: 10px;" runat="server"  >
                                       <div class="col-md-10">
                                           </div>
                                       ...
                                       <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:Button ID="submitButton" Text="Send Mail" CssClass="btn btn-sm btn-info pull-right" Visible="True" BackColor="#4183F1" runat="server" OnClick="submitButton_Click" />
                                            <asp:Button ID="textButton" Text="Add To List" OnClick="textButton_OnClick" Visible="False" CssClass="btn btn-outline-success btn-block disabled btn-sm" runat="server" />
                                        </div>
                                           </div>
                                  </div>
                            ...
                            <asp:GridView ID="SaveGridView" Width="100%" CssClass="table table-bordered text-center thead-dark" Visible="False" AutoGenerateColumns="false" runat="server">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Division" runat="server" >
                                    <ItemTemplate>
                                        <asp:Label ID="txt_division" runat="server"   Text='<%#Eval("DivisionName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
