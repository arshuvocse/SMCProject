<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MemoPrintIncrementPreviousSalary.aspx.cs" Inherits="Increment_UI_MemoPrintIncrementPreviousSalary" %>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtComplimentaryClose"  CssClass="form-control" TextMode="MultiLine" placeholder="Write first paragraph" runat="server" Text="We would like to take this opportunity to express our appreciation for your contribution to the Company and hope that you will continue to strive for better results." Font-Size="12px" Rows="4"></asp:TextBox>
                                        </div>
                                    </div>
                                      <br/>
                                          <div class="form-row">
                                   ...
                                   <br/>
                                      <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtCopyTO"    CssClass="form-control" TextMode="MultiLine" placeholder="Write first paragraph" runat="server" Text="Finance & Accounts Division
