...
public partial class Increment_UI_MemoPrintIncrement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
                                    ...
                                    try
                                    {
                                        ...
                                        if (lbl_Particulars.Text.Trim() == "Basic Pay")
                                        {
                                            ...
                                            try
                                            {
                                                basicAmount =
                                                    Math.Round(
                                                        Convert.ToDecimal(aDataTablesal.Rows[0]["Basic"].ToString()),
                                                        0);
                                            }
                                            catch (Exception)
                                            {
                                            ...
                                            res += Math.Round(Convert.ToDecimal(lbl_SalaryBreakUp.Text), 0);
                                        ...
                                        if (lbl_Particulars.Text.Trim() == "House Rent")
                                        {
                                            ...
                                            try
                                            {
                                                HouseResnt =
                                                    Math.Round(
                                                        Convert.ToDecimal(aDataTablesal.Rows[0]["HRent"].ToString()),
                                                        0);
                                            }
                                            catch (Exception)
                                            {
                                        ...
                                        if (lbl_Particulars.Text.Trim() == "Medical")
                                        {
                                            ...
                                            try
                                            {
                                                Medical =
                                                    Math.Round(
                                                        Convert.ToDecimal(aDataTablesal.Rows[0]["Medi"].ToString()),
                                                        0);
                                            }
                                            catch (Exception)
                                            {
                                        ...
                                        if (lbl_Particulars.Text.Trim() == "Conveyance")
                                        {
                                            ...
                                            try
                                            {
                                                Conveyance =
                                                    Math.Round(
                                                        Convert.ToDecimal(aDataTablesal.Rows[0]["Conv"].ToString()),
                                                        0);
                                            }
                                            catch (Exception)
                                            {
            ...
            aDAL.CheckConveyanceByMasterCode(lblEmployeeCode.Text.Trim());
                                        ...
                                        if (lbl_Particulars.Text.Trim() == "Washing")
                                        {
                                            ...
                                            try
                                            {
                                                Wash =
                                                    Math.Round(
                                                        Convert.ToDecimal(aDataTablesal.Rows[0]["Wash"].ToString()),
                                                        0);
                                            }
                                            catch (Exception)
                                            {
                                ...
                                if (ComId.Value=="1")
                                {
                                    Bodyofletter = "We are glad to inform you that the Company has decided to give you one step annual increment in your existing salary grade, " +
                                   GradeCode.Value + ", with effect from " +
                                   EffectDate + ". Your revised monthly gross salary will be taka " +
                                   res + ".00 (" + NumberToText(Convert.ToInt64(res)) + " only) in " +
                                   txtIncrementalStep.Text +
                                   ". The complete detail of your restructured salary is highlighted in Table-1 of this letter. " +
                                   EffectDate + ".";
                                }
                                else
                                {
                                    ...
                                    try
                                    {
                                            ...
                                            GradeCode.Value.Trim() == "M-4" || GradeCode.Value.Trim() == "M-5")
                                        {
                                            ...
                                            for (int kk = 0; kk < aDataTable.Rows.Count; kk++)
                                            {
                                                ...
                                                if (lbl_Particulars.Text.Trim() == "Conveyance" &&
                                                    (aDataTable.Rows[kk]["ParticularsName"].ToString().Trim() ==
                                                     "Conveyance"))
                                                {

                                                    lbl_SalaryBreakUp.Text = Math.Round(
                                                        Convert.ToDecimal(
                                                            aDataTable.Rows[kk]["SalaryBreakUp"].ToString()), 0)
                                                        .ToString();
                            ...
                            for (int i = 0; i < KeyResponGridView.Rows.Count; i++)
                            {
                                ...
                                for (int i = 0; i < KeyResponGridView.Rows.Count; i++)
                                {
                                    ...
                                    if (lbl_Particulars.Text.Trim() == "Total")
                                    {
                                        ...
                                        try
                                        {
                                            GrossAmount =
                                                Math.Round(
                                                    Convert.ToDecimal(aDataTable4.Rows[0]["GrossAmount"].ToString()),
                                                    0);
                                        }
                                        catch (Exception)
                                        {
                                    ...
                                    if (lbl_Particulars.Text.Trim() == "Medical")
                                    {
                                        ...
                                        try
                                        {
                                            GrossAmount =
                                                Math.Round(
                                                    Convert.ToDecimal(aDataTable66.Rows[0]["GrossAmount"].ToString()),
                                                    0);
                                        }
                                        catch (Exception)
                                        {
                                ...
                                DataTable aDataTable6ZZZ6 =
                                          aDAL.LoadSalaryStepGradeMId(Convert.ToInt32(HFSalaryGradeId.Value),
                                              Convert.ToInt32(HFIncrementalStepId.Value));

                                Decimal GrossAmountXX = 0;
                                try
                                {
                                    GrossAmountXX =
                                        Math.Round(
                                            Convert.ToDecimal(aDataTable6ZZZ6.Rows[0]["GrossAmount"].ToString()),
                                            0);
                                }
                                catch (Exception)
                                {
                                ...
                                if (ComId.Value == "1")
                                {
                                    Bodyofletter =
                                        ...
                                        GradeCode.Value + ", with effect from " +
                                        EffectDate + ". Your revised monthly gross salary will be taka " +
                                        res + ".00 (" + NumberToText(Convert.ToInt64(GrossAmountXX)) + " only) in " +
                                        txtIncrementalStep.Text + 
                                        "     The complete detail of your restructured salary is highlighted in Table-1 of this letter. " +
                                        EffectDate + ".";
                                }
                      ...
                      aDAL.LoadSalaryStepGradeMId(Convert.ToInt32(HFSalaryGradeId.Value), Convert.ToInt32(HFIncrementalStepId.Value));
                                    ...
                                    if (ComId.Value == "1")
                                    {
                                        ...
                                        Bodyofletter =
                                            ...
                                            GradeCode.Value + ", with effect from " +
                                            EffectDate + ". Your revised monthly gross salary will be taka " +
                                            GrossAmount2 + ".00 (" + NumberToText(Convert.ToInt64(GrossAmount2)) +
                                            " only) in " + txtIncrementalStep.Text + "." + "A breakdown of your new salary is given below: ";
                                    }
                                    else
                                    {
                                        Bodyofletter = @"The Management is pleased to inform you that your salary has been increased in your current grade on account of Annual Increment with effect from " +
            ...
            string rptTypeIdMul = "";
            DataTable dtref = aEmployeeInfoListReportDAL.GetRefEmpInfoDAL(hfEmpID.Value);
            if (dtref.Rows.Count > 0)
            {
                ...
                ReportingEmpData(hfEmpID.Value, dtref);
                string myId = "";
                ...
                rptTypeIdMul = hfEmpID.Value + "," + myId.Trim();
            }
            DataTable dtPartPrevious = new DataTable();
            if (rptTypeIdMul == "")
            {
                dtPartPrevious = aDAL.LoadMemoPrintIncrementDetailsPreviousByMId(hfEmpID.Value);
            }
            else
            {
