...
public partial class MenuSetup_MenuApprovalGroupPermissionList : System.Web.UI.Page
{
    ...
    {
        using (DataTable dt = _menuSetupCommonDal.GetMenuApprovalGroupPermissionList())
        {
    ...
    protected void lb_Edit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("MenuApprovalGroupPermission.aspx?mid=" + hdpk.Value);
    }
    ...
    protected void lb_Remove_Click(object sender, EventArgs e)
    {
        ...
        tblMenuApprovalGroupPermission IVMaster = (from emd in db.tblMenuApprovalGroupPermissions where emd.MenuApprovalGroupPermissionId == pk select emd).FirstOrDefault();
