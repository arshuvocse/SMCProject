<%@ Page Title="" Language="C#"  EnableEventValidation="false"  MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="RptSupervisorLeaveFinalApprover.aspx.cs" Inherits="MenuSetup_RptSupervisorLeaveFinalApprover" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"> Supervisor Missing List </h1>
                    </div>
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class="col-md-2" runat="server" Visible="False">
                                   ...
                                   <div class="col-md-4"  style="margin-top: 16px;">
                                       <div class="form-group">
                                           <asp:CheckBoxList runat="server" CssClass="chkChoiceDesignation" ID="chkTye" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                               <asp:ListItem>Reporting Person</asp:ListItem>
                                               <asp:ListItem>Leave Approver</asp:ListItem>
                                ...
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                   CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender"   >
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="EmpName" HeaderText="Emp. ID & Name" />
                                        ...
                                        <asp:BoundField DataField="ReportingEmp" HeaderText="Reporting Person" />
                                        <asp:BoundField DataField="LeaveEmp" HeaderText="Leave Approver" />
