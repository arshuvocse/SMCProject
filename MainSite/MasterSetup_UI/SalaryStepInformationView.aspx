<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SalaryStepInformationView.aspx.cs" Inherits="MasterSetup_UI_SalaryStepInformationView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Salary_Step_List',
                           title: 'SMC',
                           messageTop: 'Salary Step List',
                           exportOptions: {
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Salary Step List </h1>
                    </div>
                  ...
                  <div class="row" runat="server" Visible="False">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <asp:TextBox runat="server"  CssClass="form-control form-control-sm" ID="txtSearch"></asp:TextBox>
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="SalaryStepId"
                                    OnRowCommand="loadGridView_RowCommand" OnRowCreated="loadGridView_OnRowCreated"  ShowFooter="True" OnPageIndexChanging="loadGridView_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SalaryStepName" HeaderText="Salary Step Name" /> 
                                        <asp:BoundField DataField="GrossAmount" HeaderText="Gross Amount" /> 
                                        <asp:BoundField DataField="BasicAmount" HeaderText="Basic Amount" /> 
                                        ...
                                        <asp:TemplateField HeaderText="Edit"  >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                   CommandArgument='<%#Eval("SalaryStepId") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete"  >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                   CommandArgument='<%#Eval("SalaryStepId") %>'  CommandName="DeleteData"
                                         ...
                                         <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                     CommandArgument='<%#Eval("SalaryStepId") %>'  CommandName="ViewData"
