...
public partial class MasterSetup_UI_VivaSetupInfoView : System.Web.UI.Page
{
    ...
    private void LoadRegionInformation()
    {
        try
        {
            DataTable dataTable = aDaL.GetVacanceyEntryformationParam(" and tblVivaSetupInfo.CompanyId IN (" + CompanyId() + ")");
