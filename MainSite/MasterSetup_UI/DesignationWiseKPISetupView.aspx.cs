...
public partial class MasterSetup_UI_DesignationWiseKPISetupView : System.Web.UI.Page
{
    ...
    {
        DataTable dataTable = aInformationDal.GetDesignationWiseKPISetupInformation();
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("DesignationWiseKPISetup.aspx");
    }
