...
public partial class MasterSetup_UI_JobLeftTypeView : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                ...
                Session["Status"] = "Edit";
                Session["JobLeftTypeId"] = "";
                Session["JobLeftTypeId"] = areaId;
            }

            Response.Redirect("JobLeftType.aspx");
        }
         ...
         if (e.CommandName == "ViewData")
        {
            ...
            Session["JobLeftTypeId"] = "";
            Session["JobLeftTypeId"] = VacancyCirculationId;
            Session["Status"] = "View";
            Response.Redirect("JobLeftType.aspx");
        }
