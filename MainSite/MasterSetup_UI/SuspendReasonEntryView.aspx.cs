...
public partial class MasterSetup_UI_SuspendReasonEntryView : System.Web.UI.Page
{
    SuspendReasonEntryDaL aSectionInformationDal = new SuspendReasonEntryDaL();
    ...
    {
        aSectionInformationDal.GetComapnyNameList(companyDropDownList);
    ...
    {
        DataTable dataTable = aSectionInformationDal.GetInformation(" And com.CompanyId IN (" + CompanyId() + ")" + GenerateParameter() + "");
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            Response.Redirect("SuspendReasonEntry.aspx");
        }
