...
public partial class MasterSetup_UI_RegionInformationView : System.Web.UI.Page
{
    RegionInformationDal aInformationDal = new RegionInformationDal();
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            Response.Redirect("RegionInformation.aspx");
        }
