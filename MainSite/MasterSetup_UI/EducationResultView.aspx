<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EducationResultView.aspx.cs" Inherits="MasterSetup_UI_EducationResultView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Education_Result_Information_List',
                           title: 'SMC',
                           messageTop: 'Education Result Information List',
                           exportOptions: {
                               columns: [0, 1, 2]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Education Result List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="EducationResultID" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Description" HeaderText="Education Result Name" />
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument='<%#Eval("EducationResultID") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                   CommandArgument='<%#Eval("EducationResultID") %>' CommandName="DeleteData"
                                          ...
                                          <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                    CommandArgument='<%#Eval("EducationResultID") %>' CommandName="ViewData"
