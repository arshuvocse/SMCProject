...
public partial class MasterSetup_UI_DivisionInformationView : System.Web.UI.Page
{
    ...
    private void LoadDivisionInformation()
    {

        DataTable dataTable = aDivisionInformationDal.GetDivisionInformation(" WHERE di.CompanyId IN (" + CompanyId() + ")" + GenerateParameter()+"");
    ...
    private string GenerateParameter()
    {
        ...
        {
            parameter = parameter + " AND   di.CompanyId =  '" + companyDropDownList.SelectedValue + "' ";
        }
    ...
    //private void LoadCompanyformation()
    //{
    //    DataTable dataTable = aDivisionInformationDal.GetDivisionInformation();
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            Session["Status"] = "Edit";
            Response.Redirect("DivisionInformation.aspx");
        }
        ...
        if (e.CommandName == "DeleteData")
        {
            ...
            //if (dataKey != null)
            //{
            //    string divisionId = dataKey[0].ToString();

            //    if (!CheckDivisionAllocateOrNot(divisionId))
            //    {
            //        if (aDivisionInformationDal.DeleteDivisionInfoById(divisionId))
            //        {
            //            aShowMessage.ShowMessageBox(aMessages.DeleteMessage, this);
            //            LoadDivisionInformation();
            //        }
            //    }
            //    else
            //    {
