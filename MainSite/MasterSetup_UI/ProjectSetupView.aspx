<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ProjectSetupView.aspx.cs" Inherits="MasterSetup_UI_ProjectSetupView" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Project Setup List</h1>
                    </div>
                 ...
                 <%--   <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Project Setup View</a></li>
                        </ol>
                    </nav>--%>
                </div>
                <!-- //END PAGE HEADING -->
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="companyDropDownList" runat="server"  CssClass="form-control form-control-sm"  ></asp:DropDownList>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Project Setup List',
                           title: 'SMC',
                           messageTop: 'Project Setup List',
                           exportOptions: {
              ...
              background-color: #880e4f !important;
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                     CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender"   DataKeyNames="ProjectId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ShortName" Visible="False" HeaderText="Company" />   
                                        ...
                                        <asp:TemplateField HeaderText="Edit" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument="<%# Container.DataItemIndex %>" CommandName="EditData" class="glyphicon glyphicon-check"
