<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="JobLeftTypeView.aspx.cs" Inherits="MasterSetup_UI_JobLeftTypeView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: ' Job_Left_Type_List',
                           title: 'SMC',
                           messageTop: ' Job Left Type List',
                           exportOptions: {
                               columns: [0, 1, 2, 3]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"> Job Left Type List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="JobLeftTypeId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IsSubmissionDate" HeaderText=" Submission Date" />
