...
public partial class MasterSetup_UI_TrainingTopicView : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                string SuspendReasonEntryId = dataKey[0].ToString();
                Session["Status"] = "Edit";
                Session["SuspendReasonEntryId"] = "";
                Session["SuspendReasonEntryId"] = SuspendReasonEntryId;
            }

            Response.Redirect("TrainingTopicEntry.aspx");
        }

         if (e.CommandName == "ViewData")
        {
            int rowindex = Convert.ToInt32(e.CommandArgument);
            string SuspendReasonEntryId = loadGridView.DataKeys[rowindex][0].ToString();
        ...
        if (e.CommandName == "DeleteData")
        {
            ...
            DataTable dtdata = aVaencyEntryDaL.GetEvaluationData(SuspendReasonEntryId);
            if (dtdata.Rows.Count>0)
            {
                showMessageBox("Data Exist for this topic");
            }
            else
            {
                Session["SuspendReasonEntryId"] = "";
    ...
    {
      //  aVaencyEntryDaL.GetTrainingHeadingList(companyDropDownList);
    }
