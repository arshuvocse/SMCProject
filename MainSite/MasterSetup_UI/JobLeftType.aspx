<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="JobLeftType.aspx.cs" Inherits="MasterSetup_UI_JobLeftType" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Job Left Type Information  </h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:HiddenField ID="JJobLeftTypeIdHiddenField" runat="server" />
                                        <asp:TextBox ID="JobLeftTypeTextBox" runat="server" class="form-control form-control-sm"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label class="btn btn-default">
                                                <asp:CheckBox ID="chkIsSubmissionDate" Text="Is Submission Date" CssClass="checkbox margin-right" runat="server" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label class="btn btn-default">
                                                <asp:CheckBox ID="isActiveCheckBox" Text="Is Active" CssClass="checkbox margin-right" runat="server" />
