<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AddressThanaEntry.aspx.cs" Inherits="MasterSetup_UI_AddressThanaEntry" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Thana Information  </h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlDivisionName" runat="server" AutoPostBack="True" OnTextChanged="ddlDivisionName_Changed" class="form-control form-control-sm clsSelect"></asp:DropDownList>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DistrictNameDropDownList" runat="server" class="form-control form-control-sm clsSelect"></asp:DropDownList>
                                    </div>
