<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="NominationPurposeView.aspx.cs" Inherits="MasterSetup_UI_NominationPurposeView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Nomination_Purpose_List',
                           title: 'SMC',
                           messageTop: 'Nomination Purpose List',
                           exportOptions: {
                               columns: [0, 1, 2]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Nomination Purpose List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="NPID"  ShowFooter="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Description" HeaderText="Nomination Purpose Name" />
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument='<%#Eval("NPID") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                   CommandArgument='<%#Eval("NPID") %>' CommandName="DeleteData"
                                          ...
                                          <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                    CommandArgument='<%#Eval("NPID") %>' CommandName="ViewData"
