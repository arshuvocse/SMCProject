...
public partial class MasterSetup_UI_OfficeInformation : System.Web.UI.Page
{
    OfficeInformationDal aRegionInformationDal = new OfficeInformationDal();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                GetOneRecord(Session["OfficeId"].ToString());
    ...
    private void GetOneRecord(string regionId)
    {
        ...
        {
            regionHiddenField.Value = dataTable.Rows[rowIndex].Field<Int32>("OfficeId").ToString(CultureInfo.InvariantCulture);
            regionCodeHiddenField.Value = dataTable.Rows[rowIndex].Field<string>("OfficeCode");
            regionNameTextBox.Text = dataTable.Rows[rowIndex].Field<string>("OfficeName");
            regionCodeTextBox.Text = dataTable.Rows[rowIndex].Field<string>("OfficeCode");
    ...
    private bool Validation()
    {
        ...
        {
            aShowMessage.ShowMessageBox(aMessages.VOffice, this);
            return false;
        }
    ...
    {
        Response.Redirect("OfficeInformationView.aspx");
    }
}