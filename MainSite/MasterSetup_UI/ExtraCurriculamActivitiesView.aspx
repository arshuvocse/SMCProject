<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ExtraCurriculamActivitiesView.aspx.cs" Inherits="MasterSetup_UI_ExtraCurriculamActivitiesView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Extra_Curriculam_Activities_List',
                           title: 'SMC',
                           messageTop: 'Extra Curriculam Activities List',
                           exportOptions: {
                               columns: [0, 1, 2]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Extra Curriculam Activities List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="MasterExtraCurriculamId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ExtraCurriculamName" HeaderText="Extra Curriculam Activities Name" />
