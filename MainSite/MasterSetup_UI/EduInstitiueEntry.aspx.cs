...
public partial class MasterSetup_UI_EduInstitiueEntry : System.Web.UI.Page
{
    ValidationDeleteCommonDAL aValidationDeleteCommonDAL = new ValidationDeleteCommonDAL();


    EduInstitiueEntryDAL aEntryDaL = new EduInstitiueEntryDAL();
    ...
    public void ButtonVisible()
    {
        ...
        else
        {
            ...
            Response.Redirect("EduInstitiueView.aspx");
        }
                ...
                try
                {
                    ...
                    if (areaId > 0)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                          "alert",
                          "alert('Data Saved Successfully...');window.location ='EduInstitiueView.aspx';",
                          true);
                    }
                    else
                    {
    ...
    private bool Updateformation(EduInstitiueEntryDAO prepareDataForUpdate)
    {
        bool retVal;
        try
        {
    ...
    private EduInstitiueEntryDAO PrepareDataForUpdate()
    {
        var aEntryDao = new EduInstitiueEntryDAO();
    ...
    private EduInstitiueEntryDAO PrepareDataForSave()
    {
        var EntryDao = new EduInstitiueEntryDAO();
        ...
        if ( IdHiddenField.Value != "")
        {
            try
            {
                ...
                if (area)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                          "alert",
                          "alert('Data Updated Successfully...');window.location ='EduInstitiueView.aspx';",
                          true);
                }
                else
                {
                    ...
                    //    ScriptManager.RegisterStartupScript(this, this.GetType(),
                    //        "alert",
                    //        "alert('Can not be Updated! Already Defined in Employee Information Educational Institute...');window.location ='EduInstitiueView.aspx';",
                    //        true);
    ...
    protected void delButton_OnClick(object sender, EventArgs e)
    {
        ...
        if (aEntryDaL.DeleteEntryfoById( IdHiddenField.Value))
        {
            ...
            if (departmentId > 0)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Operation Successfull Done...');window.location ='EduInstitiueView.aspx';",
                    true);
            }
                    ...
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                            "alert",
                            "alert('Can not be Deleted! Already Defined in Employee Information Educational Institute...');window.location ='EduInstitiueView.aspx';",
                            true);
    ...
    private EduInstitiueEntryDAO PrepareDataForSaveDEL()
    {
        var EntryDao = new EduInstitiueEntryDAO();
