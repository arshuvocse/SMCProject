<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TrainingTopicView.aspx.cs" Inherits="MasterSetup_UI_TrainingTopicView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Training_Topic_List',
                           title: 'SMC',
                           messageTop: 'Training Topic List',
                           exportOptions: {
                               columns: [0, 1, 2, 3]
                           }
                       } 
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Training Topic List</h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="TrainingTopicId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TraingingHeading" HeaderText="Training Heading" />
                                        <asp:BoundField  DataField="TrainingTopic" HeaderText="Training Topic" />
                                        <asp:BoundField  DataField="TraingingSerial" HeaderText="Sorting Order" />
