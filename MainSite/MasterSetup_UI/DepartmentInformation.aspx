<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DepartmentInformation.aspx.cs" Inherits="MasterSetup_UI_DepartmentInformation" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Department Information </h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" runat="server" visible="True" id="mainid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label style="color: #a52a2a">*</label>
                                        <asp:HiddenField ID="departmentIdHiddenField" runat="server" />
                                    ...
                                    <div class="form-group" runat="server" id="wing" visible="False">
                                        ...
                                        <asp:DropDownList ID="wingDropDownList" class="form-control form-control-sm" runat="server"></asp:DropDownList>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <label style="color: #a52a2a">*</label>
                                        <asp:TextBox ID="departmentNameTextBox" runat="server" class="form-control form-control-sm"></asp:TextBox>
                                    </div>
