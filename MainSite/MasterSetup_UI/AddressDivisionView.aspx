<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AddressDivisionView.aspx.cs" Inherits="MasterSetup_UI_AddressDivisionView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Address Division_Information_List',
                           title: 'SMC',
                           messageTop: 'Address_Division Information List',
                           exportOptions: {
                               columns: [0, 1]
                           }
                       } 
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                      CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender"  DataKeyNames="AddressDivisionID" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Title" HeaderText="Division Name" />
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                     CommandArgument='<%#Eval("AddressDivisionID") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                    CommandArgument='<%#Eval("AddressDivisionID") %>' CommandName="DeleteData"
                                          ...
                                          <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                     CommandArgument='<%#Eval("AddressDivisionID") %>' CommandName="ViewData"
