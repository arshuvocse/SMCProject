<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EducationSubjectGroupEntry.aspx.cs" Inherits="MasterSetup_UI_EducationSubjectGroupEntry" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Subject/Group Information  </h1>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form> <asp:HiddenField ID="IdHiddenField" runat="server" />
