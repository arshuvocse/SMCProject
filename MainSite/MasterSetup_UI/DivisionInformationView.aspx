<%@ Page Title="" Language="C#" EnableViewState="true" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DivisionInformationView.aspx.cs" Inherits="MasterSetup_UI_DivisionInformationView" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Division List </h1>
                    </div>
                        ...
                        <div class="card-body"  >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="DivisionId" 
                                    OnRowCommand="loadGridView_RowCommand" OnRowCreated="loadGridView_OnRowCreated" ShowFooter="False" OnPageIndexChanging="loadGridView_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField Visible="False" DataField="ShortName" HeaderText="Company Name" />  
                                        
                                        <asp:BoundField DataField="DivisionName" HeaderText="Division Name" />  
                                        <asp:BoundField DataField="DivShortName" HeaderText="Short Name" /> 
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument='<%#Eval("DivisionId") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                     CommandArgument='<%#Eval("DivisionId") %>'  CommandName="DeleteData"
                                        ...
                                        <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                    CommandArgument='<%#Eval("DivisionId") %>' CommandName="ViewData"
