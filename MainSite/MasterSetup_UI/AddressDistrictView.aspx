<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AddressDistrictView.aspx.cs" Inherits="MasterSetup_UI_AddressDistrictView" %>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js"></script>
      ...
      <script>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Address District_Information_List',
                           title: 'SMC',
                           messageTop: 'Address_District Information List',
                           exportOptions: {
                               columns: [0, 1, 2]
                           }
                       },
       {
           ...
           messageTop: 'Address District Information List',

           filename: 'Address_District_Information_List',
           title: 'SMC',
           exportOptions: {
               columns: [0, 1, 2]
           }
    ...
    <div class="content" id="content">
        ...
        <div class="page-heading">
            <div class="page-heading__container">
                ...
                <span></span>
                <h1 class="title" style="font-size: 18px; padding-top: 9px;">District List</h1>
            </div>
                    ...
                    <div class="row" runat="server" Visible="False">
                        <div class="col-md-12">
                            <div class="pull-right">
                                <asp:Button ID="Button1" runat="server" Text="Export To Excel" class="btnexcel" OnClick="rptExport_OnClick" />
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                          CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender"  DataKeyNames="DistrictID" ShowFooter="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Titel" HeaderText="District Name" />
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="editImageButton" runat="server"
                                                            CommandArgument='<%#Eval("DistrictID") %>' CommandName="EditData"
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="deleteImageButton" runat="server"
                                                            CommandArgument='<%#Eval("DistrictID") %>' CommandName="DeleteData"
                                                ...
                                                <asp:TemplateField HeaderText="View">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="viewImageButton" runat="server"
                                                             CommandArgument='<%#Eval("DistrictID") %>' CommandName="ViewData"
