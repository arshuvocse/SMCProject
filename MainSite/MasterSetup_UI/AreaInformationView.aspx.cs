...
public partial class MasterSetup_UI_AreaInformationView : System.Web.UI.Page
{
    ...
    {
        DataTable dataTable = aInformationDal.GetAreaInformationParam(" WHERE di.CompanyId IN (" + CompanyId() + ")");
