<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeCategoryInformationView.aspx.cs" Inherits="MasterSetup_UI_EmployeeCategoryInformationView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Employee_Category_List',
                           title: 'SMC',
                           messageTop: 'Employee Category List',
                           exportOptions: {
                               columns: [0, 1, 2, 3, 4]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Employee Category List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="EmpCategoryId"  ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EmpCategoryName" HeaderText="Employee Category Name" />  
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument='<%#Eval("EmpCategoryId") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                    CommandArgument='<%#Eval("EmpCategoryId") %>' CommandName="DeleteData"
                                         ...
                                         <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                   CommandArgument='<%#Eval("EmpCategoryId") %>' CommandName="ViewData"
