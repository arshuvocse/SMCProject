<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="VivaSetupInfoView.aspx.cs" Inherits="MasterSetup_UI_VivaSetupInfoView" %>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js"></script>
                        ...
                        var table = $('#cpFormBody_loadGridView').DataTable(
                             {
                              ...
                              ,
                                     filename: 'Achievements_Information_List',
                                     title: 'SMC',
                                     messageTop: 'Achievements Information List',
                                     exportOptions: {
                                         columns: [0, 1, 2]
                                     }
                                 },
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Viva Setup List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;" >
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="VivaId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="VivaName" HeaderText="Viva Name" />
