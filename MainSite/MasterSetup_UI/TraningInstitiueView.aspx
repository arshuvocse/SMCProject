<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" ValidateRequest="false"  AutoEventWireup="true" CodeFile="TraningInstitiueView.aspx.cs" Inherits="MasterSetup_UI_TraningInstitiueView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Training_Institute_Name_List',
                           title: 'SMC',
                           messageTop: 'Training Institute Name List',
                           exportOptions: {
                               columns: [0, 1]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Training Institute Name List</h1>
                    </div>
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Description" HeaderText="Training Institute Name" />
