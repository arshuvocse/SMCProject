<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SalaryLocationInformationView.aspx.cs" Inherits="MasterSetup_UI_SalaryLocationInformationView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Office_Location_List',
                           title: 'SMC',
                           messageTop: 'Office Location List',
                           exportOptions: {
                               columns: [0, 1, 2, 3, 4, 5]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Office Location List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="SalaryLoationId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SalaryLocation" HeaderText="Office Location" />  
                                        <asp:BoundField DataField="OtherSalaryLocation" HeaderText="Location Head" />  
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                    CommandArgument='<%#Eval("SalaryLoationId") %>' CommandName="EditData"
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                   CommandArgument='<%#Eval("SalaryLoationId") %>' CommandName="DeleteData"
                                        ...
                                        <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                    CommandArgument='<%#Eval("SalaryLoationId") %>' CommandName="ViewData"
