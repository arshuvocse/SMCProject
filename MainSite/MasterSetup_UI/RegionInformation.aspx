<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="RegionInformation.aspx.cs" Inherits="MasterSetup_UI_RegionInformation" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Region Information  </h1>
                    </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                      <div class="form-group">
                                        <label> Region Name </label> <label style="color: #a52a2a">*</label>
