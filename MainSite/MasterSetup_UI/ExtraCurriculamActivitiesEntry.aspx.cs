...
public partial class MasterSetup_UI_ExtraCurriculamActivitiesEntry : System.Web.UI.Page
{
    ValidationDeleteCommonDAL aValidationDeleteCommonDAL = new ValidationDeleteCommonDAL();

    ExtraCurriculamActivitiesEntryDAL aVaencyEntryDaL = new ExtraCurriculamActivitiesEntryDAL();
    ...
    public void ButtonVisible()
    {
        ...
        {
            Response.Redirect("ExtraCurriculamActivitiesView.aspx");
        }
    ...
    private void GetOneRecord(string Vacaency)
    {
        ...
        {
            VacancyIdHiddenField.Value = dataTable.Rows[rowIndex].Field<Int32>("MasterExtraCurriculamId").ToString(CultureInfo.InvariantCulture);


            VacancyNameTextBox.Text = dataTable.Rows[rowIndex].Field<string>("ExtraCurriculamName");
                ...
                try
                {
                    ...
                    if (areaId > 0)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                          "alert",
                          "alert('Data Saved Successfully...');window.location ='ExtraCurriculamActivitiesView.aspx';",
                          true);
                    }
                }
                catch (Exception)
    ...
    private bool UpdateAreaInformation(ExtraCurriculamActivitiesEntryDAO prepareDataForUpdate)
    {
        bool retVal;
        try
        {
    ...
    private ExtraCurriculamActivitiesEntryDAO PrepareDataForUpdate()
    {
        var aVacancyEntryDao = new ExtraCurriculamActivitiesEntryDAO();

        aVacancyEntryDao.MasterExtraCurriculamId = Convert.ToInt32(VacancyIdHiddenField.Value);

        aVacancyEntryDao.ExtraCurriculamName = VacancyNameTextBox.Text.Trim();
    ...
    private ExtraCurriculamActivitiesEntryDAO PrepareDataForSave()
    {
        var aVacancyEntryDao = new ExtraCurriculamActivitiesEntryDAO();
            ...
            try
            {
                if (!CheckHobbyAllocateOrNot(VacancyIdHiddenField.Value))
                {
                    ...
                    if (area)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(),
                            "alert",
                            "alert('Data Updated Successfully...');window.location ='ExtraCurriculamActivitiesView.aspx';",
                            true);
                    }
                }
                ...
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Can not be Updated! Already Defined in Employee Information Extra Curriculam Activities...');window.location ='ExtraCurriculamActivitiesView.aspx';",
                        true);
    ...
    private void Delete()
    {
        ExtraCurriculamActivitiesEntryDAO aVacancyEntryDao = new ExtraCurriculamActivitiesEntryDAO();
        ...
        if (!CheckHobbyAllocateOrNot(VacancyIdHiddenField.Value))
        {
            ...
            if (aVaencyEntryDaL.DeleteEntryfoById(VacancyIdHiddenField.Value))
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Data Deleted Successfully...');window.location ='ExtraCurriculamActivitiesView.aspx';",
                    true);
            }
        }
        else
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(),
                "alert",
                "alert('Can not be Deleted! Already Defined in Employee Information Extra Curriculam Activities...');window.location ='ExtraCurriculamActivitiesView.aspx';",
                true);
    ...
    private bool CheckHobbyAllocateOrNot(string hobbyid)
    {
        ...
        DataTable dataTable = aValidationDeleteCommonDAL.ExtraCurriculamAllocatedOrNotEMP(hobbyid);
