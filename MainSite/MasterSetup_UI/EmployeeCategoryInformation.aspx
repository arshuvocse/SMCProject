<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeCategoryInformation.aspx.cs" Inherits="MasterSetup_UI_EmployeeCategoryInformation" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Employee Category Information </h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                       <div class="form-group">
                                            ...
                                            <asp:HiddenField ID="EmployeeCategoryIdField" runat="server" />
                                            <asp:HiddenField ID="EmployeeCategoryHiddenField" runat="server" />
                                            <asp:TextBox ID="EmployeeCategoryTextBox" runat="server" class="form-control form-control-sm" AutoPostBack="True" OnTextChanged="EmployeeCategoryTextBox_OnTextChanged"></asp:TextBox>
                                        </div>
