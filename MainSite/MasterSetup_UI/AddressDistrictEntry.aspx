<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AddressDistrictEntry.aspx.cs" Inherits="MasterSetup_UI_AddressDistrictEntry" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">District Information  </h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                      <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlDivisionName" runat="server" class="form-control form-control-sm clsSelect"></asp:DropDownList>
