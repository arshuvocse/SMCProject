<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DesignationWiseKPISetupView.aspx.cs" Inherits="MasterSetup_UI_DesignationWiseKPISetupView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Designation_Type_List',
                           title: 'SMC',
                           messageTop: 'Designation Type List',
                           exportOptions: {
                               columns: [0, 1, 2, 3, 4]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Designation Setup for Group KPI List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="DesignationWiseKPIId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EntryUser" HeaderText="Create By"/>
                                        <asp:BoundField DataField="EntryDate" HeaderText="Create Date" DataFormatString="{0:dd-MMM-yyyy}" />                                        
                                        <asp:BoundField DataField="upDateUser" HeaderText="UpdateBy"/>
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="editImageButton" runat="server"
                                                   CommandArgument='<%#Eval("DesignationWiseKPIId") %>' CommandName="EditData"
                                    ...
                                    <%--    <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="deleteImageButton" runat="server"
                                                   CommandArgument='<%#Eval("DesignationTypeId") %>' CommandName="DeleteData"
                                         ...
                                         <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="viewImageButton" runat="server"
                                                    CommandArgument='<%#Eval("DesignationWiseKPIId") %>' CommandName="ViewData"
