<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SalaryGradeInformationView.aspx.cs" Inherits="MasterSetup_UI_SalaryGradeInformationView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Salary_Grade_List',
                           title: 'SMC',
                           messageTop: 'Salary Grade List',
                           exportOptions: {
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Salary Grade List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="SalaryGradeId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EmpCategoryName" HeaderText="Empployee Category Name" /> 
                                        <asp:BoundField DataField="DesigTypeName" HeaderText="Designation Type Name" /> 
