<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="JobLocationView.aspx.cs" Inherits="MasterSetup_UI_JobLocationView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Job_Location_List',
                           title: 'SMC',
                           messageTop: 'Job Location List',
                           exportOptions: {
                               columns: [0, 1, 2, 3, 4, 5]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Job Location List </h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="JobLocationID" ShowFooter="True"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL">
                                          ...
                                          <asp:BoundField DataField="SalaryLocation" HeaderText="Office Name" />
