<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Chart2.aspx.cs" Inherits="ChartTest_Chart2" %>
                               ...
                               <%-- <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>--%>
                                        ...
                                        <asp:DropDownList runat="server" ID="DptBarChart4DropDownList" CssClass="form-control form-control-sm" Width="200" AutoPostBack="True" OnSelectedIndexChanged="DptBarChart4DropDownList_OnSelectedIndexChanged" />
                                                ...
                                                <select id="ddlDEPT" runat="server">
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                ...
                                                $("btnGeneratePieChart").on('click', function (e) {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "../App_Code/WebService.asmx/getTrafficSourceData",
                                                        data: jsonData,
