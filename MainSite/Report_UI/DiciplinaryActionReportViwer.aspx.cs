...
public partial class Report_UI_DiciplinaryActionReportViwer : System.Web.UI.Page
{   
    ...
    EmployeeDiciplinaryReportDAL aDAL = new EmployeeDiciplinaryReportDAL();
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (rptType != "")
        {
                ...
                allDataTable = aDAL.EmpDiciplinaryInformation(Convert.ToInt32(rptType).ToString()).Copy();
             //   HiddenEmpId.Value = allDataTable.Rows[0]["EmployeeId"].ToString();
                allDataTable.TableName = "EmployeeDiciplinaryDataTable";
                ...
                {
                 //   mainDS.WriteXmlSchema(MapPath("~\\Reports\\DataSets\\EmployeeDiciplinaryListInfo.xsd"));
                  ShowReport(mainDS, "crpEmployeeDiciplinaryListInfo.rpt");
                }
