...
public partial class Report_UI_EmpTransferAndRedesignationReportViwer : System.Web.UI.Page
{   
    ...
    EmpTransferAndRedesignationDAL aListReportDAL = new EmpTransferAndRedesignationDAL();
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (rptType != "")
        {
                ...
                allDataTable = aListReportDAL.GetEmpTransferAndRedesignationInfoDALrpt(rptType).Copy();
                allDataTable.TableName = "EmpTransferAndRedesignationListDataTable";
                ...
                {
                  //  mainDS.WriteXmlSchema(MapPath("~\\Reports\\DataSets\\EmpTransferAndRedesignationListInfo.xsd"));
                  ShowReport(mainDS, "crpEmpTransferAndRedesignationList.rpt");
                }
