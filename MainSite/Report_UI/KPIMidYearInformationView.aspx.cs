...
public partial class Report_UI_KPIMidYearInformationView : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (empId != null)
        {
            ...
            allDataTable = _appPartA.GetEmployeeDetailsKPIMIDYearREport(Convert.ToInt32(empId), finYear).Copy();
            ...
            if (dtaa.Rows.Count > 0)
            {
                ...
                DataTable gtGetApprisalMasterId = _appPartA.GetKPIMIDYearAppraisalMasterIdFromAppraisalSelfMasterId(Convert.ToInt32(mid));
                ...
                DataTable dtFunc = _appPartA.GetAppraisalFuncDetailsKPIMIDYear(AppraisalMasterId).Copy();
                ...
                dtAppraisalfB = _appPartA.GetAppraisalfKPIMIDYear(AppraisalMasterId).Copy();
                ...
                dtw2 = _appPartA.GetAppraisalfDetailsFromSupKPIMIDYear(Convert.ToInt32(mid)).Copy();
                ...
                dtTrain = _appPartA.GetAppraisalTraining(Convert.ToInt32(0)).Copy();
                ...
                dtFinalStatus = _appraisalPartBdal.GetAppraiSalFinalStatusrptKPIMIdYear(Convert.ToInt32(AppraisalMasterId)).Copy();
                ...
                if (dtFinalStatus.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        if (res == 0)
                        {
                            dtFinalStatus = _appraisalPartBdal.GetAppraiSalFinalStatusrptSelfForKPIMIDYear(Convert.ToInt32(AppraisalMasterId)).Copy();
                        }
                ...
                if (dtFinalStatus.Rows.Count==0)
                {
                    ...
                    if (dtFinalStatus.Rows.Count==0)
                    {
                        dtFinalStatus = _appraisalPartBdal.GetAppraiSalFinalStatusrptSelfForKPIMIDYear(Convert.ToInt32(mid)).Copy();
      ...
      ShowReport(mainDS, "crpKPIMidYearInformamationDetails.rpt");
