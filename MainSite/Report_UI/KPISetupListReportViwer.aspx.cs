...
public partial class Report_UI_KPISetupListReportViwer : System.Web.UI.Page
{   
    ...
    KPISetupListReportViwerDAL aEmployeeInfoListReportDAL = new KPISetupListReportViwerDAL();
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (rptType != "")
        {
                ...
                allDataTable.TableName = "KPIMasterDataTable";
                ...
                EmpChildrenDataTable.TableName = "KPIDetailsDataTable";
                mainDS.Tables.Add(EmpChildrenDataTable);


                if (mainDS.Tables[0].Rows.Count > 0)
                {
                   //   mainDS.WriteXmlSchema(MapPath("~\\Reports\\DataSets\\KPISetupListListInfo.xsd"));
                  ShowReport(mainDS, "crpKPISetupListInfoReport.rpt");
                }
