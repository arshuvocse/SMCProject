...
public partial class Report_UI_SalaryMatrixViewer : System.Web.UI.Page
{   
    ...
    SalaryMatrixReportDAL aListReportDAL = new SalaryMatrixReportDAL();
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (rptType != "")
        {
                ...
                allDataTable = aListReportDAL.GetMatrixReport(rptType).Copy();

                allDataTable.TableName = "dtMatrixReport";
                ...
                {
                   //   mainDS.WriteXmlSchema(MapPath("~\\Reports\\DataSets\\dsMatrixReport.xsd"));
                     ShowReport(mainDS, "rptMatrixReport.rpt");
                }
