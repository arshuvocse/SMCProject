<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeePromotionEntryViewReportViwer.aspx.cs" Inherits="Report_UI_EmployeePromotionEntryViewReportViwer" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                   <asp:HiddenField runat="server" ID="HiddenEmpId" />
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box">
