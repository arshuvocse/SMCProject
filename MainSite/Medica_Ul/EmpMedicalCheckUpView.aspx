<%@ Page Title="" Language="C#"  EnableViewState="true" MaintainScrollPositionOnPostback="true"  MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmpMedicalCheckUpView.aspx.cs" Inherits="Medica_Ul_EmpMedicalCheckUpView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Medical Check-Up List',
                           title: 'SMC',
                           messageTop: 'Medical Check-Up List',
                           exportOptions: {
           ...
           .table   thead th {
             ...
             <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Medical Check-Up List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                             ...
                             <div class="form-row">
                                    <div class="col-2">
                                        <div class="form-group ">
                                            ...
                                            <asp:DropDownList runat="server" AutoPostBack="True" ID="ddlCompany"   class="form-control form-control-sm" />
                                        </div>
                                    </div>
                                    
                                     <div class="col-2">
                                    <div class="form-group">
                                        <label>Check-up From Date</label>   
                                  ...
                                  <div class="col-2">
                                    <div class="form-group">
                                        <label>Check-up To Date</label>   
                                        <asp:TextBox runat="server" ID="txtToDate" class="form-control form-control-sm" />
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;" >
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="MedicalCheckUpMasterId"  
