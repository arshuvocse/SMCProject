...
public partial class MeetingMinors_SubcommitteeSetupView : System.Web.UI.Page
{
    SubcommitteeSetupDAL aMaDal=new SubcommitteeSetupDAL();
    ...
    private void load()
    {
        DataTable dt = aMaDal.loadMember(GenerateParameter());
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "EditData")
        {
            ...
            Response.Redirect("SubcommitteeSetup.aspx");
        }
        ...
        //if (e.CommandName == "EditData")
        //{
        //    Response.Redirect("SubcommitteeSetup.aspx?ID="+Id);
        //}
    ...
    protected void btnEdit_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SubcommitteeSetup.aspx?MID=" + hfMasterId.Value.Trim());
    }
