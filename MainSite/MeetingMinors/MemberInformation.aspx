<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MemberInformation.aspx.cs" Inherits="MeetingMinors_MemberInformation" %>
            ...
            <asp:UpdateProgress ID="progress" runat="server" ClientIDMode="Static" DisplayAfter="0" DynamicLayout="true">
                    ...
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" />  Member Information </h1>
                        </div>
   ...
   <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                          ...
                          <div class="row">
                            ...
                            <div style="padding-top: 5px;"></div>    
                            <div class="row">
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Description: </label></div>
                                <div class="col-md-6">  <asp:TextBox runat="server"  Rows="3" TextMode="MultiLine"  ID="TxtDescription"  class="form-control" /></div>
                            </div>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
                <div class="row">
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Company:<span   style="color:red; " title="please fill out this field"> * </span></label></div>
                            <div class="col-md-6"><asp:DropDownList runat="server" ID="ddlCompany" class="form-control form-control-sm SelectMe33" />  </div>
                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                 ...
                                 <%--<asp:DropDownList runat="server"   ID="ddlMemberType"  class="form-control form-control-sm">
                                    
Member Type
                                     <asp:ListItem Value="0">Select One..........</asp:ListItem>
                                     <asp:ListItem>Company Member</asp:ListItem>
                                     <asp:ListItem>Non-Company Member</asp:ListItem>
                                     <asp:ListItem>Board Secretary</asp:ListItem>
                                    
                                 </asp:DropDownList>--%>
                                 <asp:DropDownList runat="server"   ID="ddlMemberType"   class="form-control form-control-sm SelectMe33" ></asp:DropDownList>
                                 ...
                                 <asp:TextBox runat="server"   ID="txtMemberType" Visible="False"  class="form-control form-control-sm" />
                            </div>
               ...
               <div style="padding-top: 5px;"></div>
                 <div class="row">
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Order No:</label></div>
                            <div class="col-md-6">  <asp:DropDownList runat="server"    ID="ddlOrderNo"  class="form-control form-control-sm SelectMe33" /></div>
                          </div>
           </div>
  ...
  <tr>
    ...
    <td> <asp:LinkButton runat="server" ID="LinkButton1"   CssClass="btn btn-sm btn-warning"><span aria-hidden="true" class="fa fa-edit"></span>  </asp:LinkButton>  <asp:LinkButton runat="server" ID="LinkButton2"   CssClass="btn btn-sm btn-danger"><i class="fa fa-minus-circle"></i> </asp:LinkButton></td>
            ...
            <div style="overflow: scroll; width: 100%">
                                                <asp:GridView Margin="0,5,0,0" ID="gv_Children" runat="server" AutoGenerateColumns="false" CssClass="AddToListCssTable"  ShowHeaderWhenEmpty="True"  OnPreRender="gv_DocumentUpload_PreRender">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Order No.">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_OrderNo" runat="server" Text='<%#Eval("OrderNo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
