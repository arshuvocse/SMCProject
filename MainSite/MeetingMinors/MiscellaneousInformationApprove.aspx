<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" enableEventValidation="false" AutoEventWireup="true" CodeFile="MiscellaneousInformationApprove.aspx.cs" Inherits="MeetingMinors_MiscellaneousInformationApprove" %>
  ...
  <asp:UpdatePanel runat="server">
      <ContentTemplate>
       ...
       <br/>
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                        <asp:GridView Width="100%" ShowHeader="True" ID="gv_EmpListSearch" runat="server" AutoGenerateColumns="false" CssClass="blueTableNew"   OnPreRender="gv_DocumentUpload_PreRender">
                                            <Columns>
                 ...
                 <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            ...
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Document Approval Information   </h1>
                        </div>
                                            <div class="page-heading__container float-right d-none d-sm-block">
                                               
                                                <span class="alert alert-info"><span style="font-weight: bold">Next Approver:</span>  <asp:Label  ID="lblNextApp" runat="server"></asp:Label></span>
                        ...
                        <asp:LinkButton ID="LinkButton2"  style="font-style: normal!important; font-weight: bold"   CssClass="btn btn-sm btn-outline-success " runat="server" OnClick="detailsViewButton_OnClick" > <i class="fa fa-backward"></i>&nbsp;Back to List</asp:LinkButton>
...
&nbsp; Return </asp:LinkButton> 
                                              ...
                                              <div class="or or-sm" runat="server"   id="orBTN"></div>
                                                ...
                                                <asp:LinkButton ID="btnApprove" Text="Submit" CssClass="btn btn-sm btn-info"   runat="server" OnClick="Button1_OnClick" OnClientClick="return confirm('Are you sure you want to Approve ?')" style="box-shadow: 0 0 3px 1px rgba(0,0,0,.35);"  ><i class="fa fa-check" aria-hidden="true"></i> &nbsp; Approve
...
Subject</td>
                                                     ...
                                                     <tr runat="server" Visible="False">
                                                        <td class="tblTHColorChang"  style="width: 20%; padding: 10px;">
Purpose</td>
                                                        <td>   <asp:Label ID="lblPurpose" runat="server"></asp:Label></td>
               ...
               <br/>
                                                <div class="row">
                                                    <div class="col-md-8">
                                                                  ...
                                                                  <asp:GridView Width="100%" ShowHeader="True" ID="gv_DocumentUpload" runat="server" AutoGenerateColumns="false" CssClass="AddToListCssTable"   OnPreRender="gv_DocumentUpload2_PreRender">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SL#">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex + 1%>
                                                ...
                                                <asp:TemplateField HeaderText="Document">
                                                    <ItemTemplate>
                                                         ...
                                                         <a class="btn btn-sm btnMyDesignSearch"   Target="_blank"    href="<%# Eval("DocumentLinkPreview") %>">Preview</a>
                                                          <asp:HyperLink ID="HLDocumentLink"   Target="_blank"  runat="server" Visible="False" NavigateUrl='<%# Eval("DocumentLink") %>'  CssClass="btn btn-sm btnMyDesignSearch"   Text='Preview'>
        </asp:HyperLink>
                                                        ...
                                                        <asp:HiddenField runat="server" ID="hfDocumentLink" Value='<%#Eval("DocumentLink")%>' />
                                                         ...
                                                         <asp:HiddenField runat="server" ID="hfMintuesEntryInfoDocumentID" Value='<%#Eval("MiscellaneousInfoDocumentID")%>' />
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="SL#">
                                                  ...
                                                  <asp:TemplateField HeaderText="Action Status">
                                                    ...
                                                    <asp:BoundField DataField="ApprovedDate" HeaderText="Approved Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}" />
                        ...
                        <div class="form-group ">
                          ...
                          <%--  <div style="padding-top: 5px;"></div>--%>
                            <div class="row">
                              ...
                              <div style="padding-top: 5px;"></div>
                            <div class="row">
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Purpose:</label></div>
                                <div class="col-md-6">  <asp:TextBox runat="server"   TextMode="MultiLine" Rows="2"    ID="txtPurpose"  class="form-control  " /></div>
                            </div>
