...
public partial class MeetingMinors_RoutingPathSetupView : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        string Id = gv_loadGridView.DataKeys[rowindex][0].ToString();
         ...
         if (e.CommandName == "EditData")
         {
             ...
             Response.Redirect("RoutingPathSetup.aspx");
         }
    ...
    protected void btnEdit_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("RoutingPathSetup.aspx?MID=" + hfMasterId.Value.Trim());
    }
