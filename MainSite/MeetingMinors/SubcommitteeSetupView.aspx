<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SubcommitteeSetupView.aspx.cs" Inherits="MeetingMinors_SubcommitteeSetupView" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Sub-Committee  Setup List</h1>
              ...
              var table = $('#cpFormBody_gv_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Board Member Information',
                           title: 'SMC',
                           messageTop: 'Board Member Information',
                           exportOptions: {
                        ...
                        <ContentTemplate>
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: hidden;">
                                <asp:GridView ID="gv_loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="AddToListCssTable"    OnPreRender="gv_DocumentUpload_PreRender" DataKeyNames="SubcommitteeMasterId" OnRowCommand="loadGridView_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL">
                                            <ItemTemplate>
                                                <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                     <asp:HiddenField runat="server" ID="hfMasterId" Value='<%#Eval("SubcommitteeMasterId")%>' />

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="ShortName" HeaderText="Company" />
                                        <asp:BoundField DataField="MeetingCategory" HeaderText="Meeting Category" />
                                        <asp:BoundField DataField="SubCommitteeName" HeaderText="Sub-Committee Name" />
