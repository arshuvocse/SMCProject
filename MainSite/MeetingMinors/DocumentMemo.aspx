<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DocumentMemo.aspx.cs" Inherits="MeetingMinors_DocumentMemo" %>
                 ...
                 <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            ...
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Approved Document Memo List </h1>
                        </div>
                                              ...
                                              <asp:TemplateField HeaderText="Purpose" Visible="False">
                                                ...
                                                <asp:TemplateField HeaderText="Print">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton runat="server" ID="btnEdit"   OnClick="btnEdit_OnClick"   CssClass="btn btn-sm btnMyDesignAddtoList"><i class="fa fa-print"></i> &nbsp; Print </asp:LinkButton>
