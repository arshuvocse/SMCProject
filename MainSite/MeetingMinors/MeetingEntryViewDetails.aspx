<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MeetingEntryViewDetails.aspx.cs" Inherits="MeetingMinors_MeetingEntryViewDetails" %>
                        ...
                        <div class="modal-body">
                         ...
                         $('#<%=ddlDepartment.ClientID%>').chosen({ disable_search_threshold: 5, search_contains: true });
                                        ...
                                        <div class="col-md-1" style="padding-top: 8px">
                                            <label class="control-label ">Department:</label></div>
                                        <div class="col-md-4">
                                            <asp:DropDownList runat="server" ID="ddlDepartmentAPP" class="form-control form-control-sm"></asp:DropDownList></div>
                                        <div class="col-md-2">
        ...
        <div class="container-fluid">
            <div class="page-heading">
                ...
                <div class="page-heading__container float-right d-none d-sm-block">
                    <span style="display: none" class="alert alert-info"><span style="font-weight: bold">Next Approver:</span>
                        <asp:Label ID="lblNextApp" runat="server"></asp:Label></span>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:DropDownList runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOffice_OnSelectedIndexChanged" ID="ddlOffice" CssClass="form-control form-control-sm" /></div>
                                            </div>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:DropDownList runat="server" ID="ddlLocation" AutoPostBack="True" OnSelectedIndexChanged="ddlLocation_OnSelectedIndexChanged" CssClass="form-control form-control-sm" /></div>
                                            </div>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:DropDownList runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFloor_OnSelectedIndexChanged" ID="ddlFloor" CssClass="form-control form-control-sm" /></div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4" style="padding-top: 8px">
                                                    <label class="control-label pull-right">Meeting Room:</label></div>
                                                <div class="col-md-8">
                                                    <asp:DropDownList runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlMettingRoomName_OnSelectedIndexChanged" ID="ddlMettingRoomName" CssClass="form-control form-control-sm" /></div>
                                            </div>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox runat="server" ID="txtCapacity" CssClass="form-control form-control-sm" /></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox runat="server" ID="txtLocation" CssClass="form-control form-control-sm" /></div>
                                            </div>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox runat="server" ID="txtDescription" CssClass="form-control form-control-sm" /></div>
                                            </div>
                                        </div>
...
:</label>
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox runat="server" ID="txtRemarks" CssClass="form-control" TextMode="MultiLine" Rows="3" /></div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Date</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Meeting Category</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblMeetingCategory"></asp:Label></td>


                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Start Time</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Sub-Committee Name</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblSubCommitteeName"></asp:Label></td>


                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">End Time</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Meeting Note</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblMeetingNote"></asp:Label></td>


                                      <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Notice</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblNotice"></asp:Label></td>
                                        ...
                                        <div runat="server" id="divOfficePremisis" visible="False">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblOffice"></asp:Label></td>
                                                ...
                                                <tr>
                                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Location</td>
                                                    <td>
                                                        <asp:Label runat="server" ID="lblLocation2"></asp:Label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblFloor"></asp:Label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblMeetingRoom"></asp:Label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblCapacity"></asp:Label></td>
                                        ...
                                        <div runat="server" id="divOuterPremisis" visible="False">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Location</td>
                                                    <td>
                                                        <asp:Label runat="server" ID="lblOuterLocation"></asp:Label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblOuterDescription"></asp:Label></td>
                                        ...
                                        <div runat="server" id="divVirtualMeeting" visible="False">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblRemarks"></asp:Label></td>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Position">
                                        <ItemTemplate>
                                            ...
                                            <asp:RadioButtonList runat="server" ID="chkBoardMemberPosition" CssClass="chkChoice" RepeatDirection="Horizontal">
                            ...
                            <asp:GridView ID="gv_AgendaList" runat="server" CssClass="blueTableNew" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Agenda">
                                        <ItemTemplate>
                                            <asp:Label ID="txtAgenda" runat="server" Text='<%#Eval("Agenda") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Observation">
                                        <ItemTemplate>
                                            <asp:Label ID="txtObservation" runat="server" Text='<%#Eval("Observation") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Decision">
                                        <ItemTemplate>
                                            <asp:Label ID="txtDecision" runat="server" Text='<%#Eval("Decision") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Implementation Status">
                                        <ItemTemplate>
                                            <asp:Label ID="ImplementationStatus" runat="server" Text='<%#Eval("ImplementationStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox runat="server" ID="txtTitle" TextMode="MultiLine" Rows="2" class="form-control " /></div>
                                                                </div>
...
:<span style="color: red;" title="please fill out this field"> * </span>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox runat="server" ID="txtMeetingpurpose" class="form-control" TextMode="MultiLine" Rows="3" /></div>
                                                                </div>
                                                                <fieldset class="for-panel" runat="server" visible="False">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3" style="padding-top: 8px">
                                                                            <label class="control-label pull-right">
                                                                                <asp:RadioButton runat="server" CssClass="chkChoice" Text="By Deparment" ID="rbDeptBy" /></label></div>
                                                                        <div class="col-md-6">
                                                                            <asp:DropDownList runat="server" ID="ddlDept" class="form-control form-control-sm" /></div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3" style="padding-top: 8px">
                                                                            <label class="control-label pull-right">
                                                                                <asp:RadioButton runat="server" Text="By Employee" CssClass="chkChoice" ID="RadioButton1" /></label></div>
                                                                        <div class="col-md-6">
                                                                            <asp:DropDownList runat="server" ID="DropDownList1" class="form-control form-control-sm" /></div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3" style="padding-top: 8px">
                                                                            <label class="control-label pull-right">
                                                                                <asp:RadioButton runat="server" CssClass="chkChoice" Text="Other" ID="RadioButton2" /></label></div>
                                                                        <div class="col-md-6">
                                                                            <asp:TextBox runat="server" ID="txtOther" class="form-control form-control-sm" /></div>
...
:</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3" style="padding-top: 8px">
                                                                    <label class="control-label pull-right">Date:<span style="color: red;" title="please fill out this field"> * </span></label>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <asp:TextBox runat="server" ID="txtMeetingDate" class="form-control form-control-sm" />
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3" style="padding-top: 8px">
                                                                    <label class="control-label pull-right">Start Time:</label></div>
                                                                <div class="col-md-6">
                                                                    <asp:TextBox runat="server" ID="txtStartTime" TextMode="Time" class="form-control form-control-sm" /></div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3" style="padding-top: 8px">
                                                                    <label class="control-label pull-right">End Time:</label></div>
                                                                <div class="col-md-6">
                                                                    <asp:TextBox runat="server" ID="txtEndTime" TextMode="Time" class="form-control form-control-sm" /></div>
                                                            </div>
