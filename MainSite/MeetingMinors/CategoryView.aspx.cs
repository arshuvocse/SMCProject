...
public partial class MeetingMinors_CategoryView : System.Web.UI.Page
{
        ...
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                ...
                if (MId == "1" || MId == "2")
                {
                    ...
                    //    "alert",
                    //    "alert('Can not be edited or deleted');window.location ='CategoryView.aspx';",
                    //    true);
                }
                else
                {
                    ...
                    Session["MId"] = "";
                    Session["MId"] = MId;
                    Response.Redirect("~/MeetingMinors/MeetingCategoryEntry.aspx");
                }
            }
