<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ApprovedDocumentList.aspx.cs" Inherits="MeetingMinors_ApprovedDocumentList" %>
                 ...
                 <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            ...
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Document Approved List </h1>
                        </div>
...
<asp:UpdatePanel runat="server">
   ...
   <div class="card-body">
       ...
       <style>
                                              ...
                                              <asp:TemplateField HeaderText="Purpose" Visible="False">
                                                 ...
                                                 <%-- <asp:TemplateField HeaderText="Updated By">
                                                  ...
                                                  <asp:TemplateField HeaderText="Comments">
                                                    <ItemTemplate>
                                                         <asp:TextBox runat="server"    ID="txtComments"  class="form-control" TextMode="MultiLine" Rows="2" />
                                                         </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Actions">
                                                    <ItemTemplate>
                                                        
                                                        <asp:LinkButton runat="server" ID="btnEdit" Visible="False" OnClick="btnEdit_OnClick"   CssClass="btn btn-sm btnMyDesignGrid">&nbsp; Returned </asp:LinkButton>
                                                        
                                                         <asp:LinkButton runat="server" ID="btnReturned" OnClick="btnReturned_OnClick"   CssClass="btn btn-sm btnMyDesignGrid">&nbsp; Returned </asp:LinkButton>
        ...
        <asp:Panel ID="pnAppraisalApproval" runat="server" Style="display: none; overflow: scroll; padding: 10px" Height="550px" Width="60%" CssClass="modalPopup">
                    ...
                    <ProgressTemplate>
                        <div class="divWaiting">
                            <asp:Image ID="imgWawwwwdfgwwwit" CssClass="position-set" runat="server" ImageAlign="Middle" ImageUrl="~/Assets/img/progress-bar-opt.gif" Width="120px" Height="120px" />
                                                    ...
                                                    <div class="col-md-8" style="padding-left: 15px;padding-top: 12px;">
                                                          <div class="text-left">
                                                   <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> New Path for Document Approval</h1> 
                                                </div>
                                                    </div>
                                                     <div class="col-md-2"></div>
                                                    <div class="col-md-2" style="padding-top: 15px;padding-right: 15px;">
                                                          <asp:LinkButton ID="btnApprasalResetClose"  style="font-size: 16px"  OnClick="btnApprasalResetClose_Click" CssClass="btn btn-sm btn-danger pull-right  pull-right" runat="server"> Close
</asp:LinkButton>
                                                    </div>
                                                </div>
                                      ...
                                      <div class="col-md-12">
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                     ...
                                                     <asp:LinkButton runat="server" ID="lbCancelAppraisalSubmit" OnClick="lbCancelAppraisalSubmit_OnClick"  style="font-size: 20px!important;" CssClass="btn btnMyDesignSave"><i class="fa fa-check "></i>&nbsp;Submit Information</asp:LinkButton>
