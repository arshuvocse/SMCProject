...
public partial class MeetingMinors_RoutingPathSetup : System.Web.UI.Page
{
    RoutingPath aRoutingPath = new RoutingPath();
    ...
    private void GetRecord(int id)
    {
        ...
        if (Master.Rows.Count > 0)
        {
            ...
            TxtRoutingPathName.Text = Master.Rows[0].Field<string>("RoutingPath_Name").Trim().ToString();
    ...
    private RoutingPathSetupMaster PrepareDataForSaveMaster()
    {

        RoutingPathSetupMaster aMaster = new RoutingPathSetupMaster();
        {
            aMaster.CompanyId = Convert.ToInt32(ddlCompany.SelectedValue);
            aMaster.RoutingPath_Name = TxtRoutingPathName.Text.ToString();
    ...
    private RoutingPathSetupMaster PrepareDataForUpdateMaster()
    {

        RoutingPathSetupMaster aMaster = new RoutingPathSetupMaster();
        {
            aMaster.RoutingPathMaster_ID = Convert.ToInt32(PathId.Value);
            aMaster.CompanyId = Convert.ToInt32(ddlCompany.SelectedValue);
            aMaster.RoutingPath_Name = TxtRoutingPathName.Text.ToString();
            aMaster.DivisionId = Convert.ToInt32(ddlDivision.SelectedValue);
            aMaster.DepartmentId = Convert.ToInt32(ddlDepartment.SelectedValue);
    ...
    private List<RoutingPathSetupDetails> PrepareDataForSaveDetails(Int32 Val)
    {
        RoutingPathSetupDetails aMemberSetupDetails;
        List<RoutingPathSetupDetails> aMemberSetupDetailsesList = new List<RoutingPathSetupDetails>();
        ...
        for (int i = 0; i < gv_SaveGridView.Rows.Count; i++)
        {
            ...
            aMemberSetupDetails = new RoutingPathSetupDetails();
            aMemberSetupDetails.RoutingPathMaster_ID = Convert.ToInt32(Val);
    ...
    private List<RoutingPathSetupDetails> PrepareDataForUpdateDetails( )
    {
        RoutingPathSetupDetails aMemberSetupDetails;
        List<RoutingPathSetupDetails> aMemberSetupDetailsesList = new List<RoutingPathSetupDetails>();
