<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MeetingRoomView.aspx.cs" Inherits="MeetingMinors_MeetingRoomView" %>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Occupation_Information_List',
                           title: 'SMC',
                           messageTop: 'Occupation Information List',
                           exportOptions: {
                               columns: [0, 1]
                           }
                       },
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Meeting Rooms List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="MeetingRoomId" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MeetingRoomName" HeaderText="Meeting Room Name" />
                                        <asp:BoundField DataField="MeetingRoomCapacity" HeaderText="Meeting Room Capacity" />
