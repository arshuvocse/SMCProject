<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="MiscellaneousInformationView.aspx.cs" Inherits="MeetingMinors_MiscellaneousInformationView" %>
                 ...
                 <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            ...
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Document Information List </h1>
                        </div>
         ...
         <div class="row">
                        ...
                        <div class="form-group ">
                          ...
                          <div class="row">
                            ...
                            <div style="padding-top: 5px;"></div>
                             <div class="row">
                                  <div class="col-md-2"></div>
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Initiated from Date:</label></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                                ...
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Initiated By:</label></div>
                            <div class="col-md-6">  <asp:DropDownList runat="server"    ID="ddlCreatedBy"  class="form-control form-control-sm" />
                             ...
                             <div style="padding-top: 5px;"></div>
                             <div class="row">
                                <div class="col-md-3" style="padding-top: 8px">  <label class="control-label pull-right">Initiated to Date:</label></div>
              ...
              <div class="col-md-12">
                        <div class="form-group ">
                            ...
                            <div class="col-md-6">  <asp:DropDownList runat="server"   Visible="False" ID="ddlKeySearch"  class="form-control form-control-sm" />
                                
                                <asp:TextBox runat="server"    ID="txtKeySearch"  class="form-control form-control-sm" AutoPostBack="True" OnTextChanged="txtKeySearch_OnTextChanged" />
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters=""
                                                        EnableCaching="False" Enabled="True" MinimumPrefixLength="1" CompletionSetCount="100000"
                                                        ServiceMethod="getMiscellaneousKeySearch" ServicePath="~/WebService.asmx" TargetControlID="txtKeySearch"
                                                        UseContextKey="False" CompletionListCssClass="autocomplete_completionListElement222"
                                                ...
                                                <asp:TemplateField HeaderText="Company">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField runat="server" ID="hfMiscellaneousInfoId" Value='<%#Eval("MiscellaneousInfoId")%>' />
                                                          <asp:HiddenField runat="server" ID="HiddenField1" Value='<%#Eval("MiscellaneousInfoId")%>' />
