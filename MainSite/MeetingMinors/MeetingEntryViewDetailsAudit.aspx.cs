...
public partial class MeetingMinors_MeetingEntryViewDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       ButtonVisible();
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["MID"]))
            {
                ...
                {
                    dtMaster = AMeetingEntryDal.GetMasterDataByIdApproval(id_mastetID.Value);
                    
                }
                else
                {
                    dtMaster = AMeetingEntryDal.GetMasterDataByIdAudit(id_mastetID.Value);
                }
