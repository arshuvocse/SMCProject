...
public partial class Survey_surveyQuestionGroupView : System.Web.UI.Page
{
    ...
    private bool CheckAchievementsAllocateOrNot(int MainID)
    {
        ...
        {
            result = (from t in db.tblSurveyQuestions
                      where t.SurveyQuestionGroupId == MainID
                      select t).Count();
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                int mainID = Convert.ToInt32(dataKey[0]);
                ...
                if (!CheckAchievementsAllocateOrNot(mainID))
                {
                    ...
                    Response.Redirect("surveyQuestionGroupEntry.aspx");
                }
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Can not be Updated !!   ');window.location ='surveyQuestionGroupView.aspx';",
                        true);
                }
        ...
        if (e.CommandName == "DeleteData")
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Can not be Deleted !!   ');window.location ='surveyQuestionGroupView.aspx';",
                    true);
            }
        }
