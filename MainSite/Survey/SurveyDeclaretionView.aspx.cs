...
public partial class Survey_SurveyDeclaretionView : System.Web.UI.Page
{
    ...
    private void LoadRegionInformation()
    {
        try
        {
            DataTable dataTable = aVaencyEntryDaL.LoadAllInfofById();
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                string areaId = dataKey[rowindex].ToString();

                 int mainID = Convert.ToInt32(dataKey[rowindex]);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Can not be Updated !!   ');window.location ='SurveyDeclaretionView.aspx';",
                        true);
                }
            }
        ...
        if (e.CommandName == "DeleteData")
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Can not be Deleted !!   ');window.location ='SurveyDeclaretionView.aspx';",
                    true);
            }
        }
    ...
    protected void lb_SendMail_OnClick(object sender, EventArgs e)
    {
        ...
        HiddenField hdpk = (HiddenField)loadGridView.Rows[rowID].FindControl("hdpk");

        Response.Redirect("SurveyParticipantSendMAil.aspx?mid=" + hdpk.Value);
    }
}