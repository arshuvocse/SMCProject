...
public partial class Survey_SurveyQuestionSetupView : System.Web.UI.Page
{
    ...
    private bool CheckAchievementsAllocateOrNot(int MainID)
    {
        ...
        {
            result = (from t in db.tblSurveyDetails
                      where t.SurveyQuestionId == MainID 
                      select t).Count();
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            if (dataKey != null)
            {
                ...
                int mainID = Convert.ToInt32(dataKey[0].ToString());
                ...
                if (!CheckAchievementsAllocateOrNot(mainID))
                {
                    ...
                    Response.Redirect("SurveyQuestionSetupEntry.aspx");
                }
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Can not be Updated !!   ');window.location ='SurveyQuestionSetupView.aspx';",
                        true);
                }
            }
        ...
        if (e.CommandName == "DeleteData")
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Can not be Deleted !!   ');window.location ='SurveyQuestionSetupView.aspx';",
                    true);
            }
        }
