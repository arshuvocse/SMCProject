<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ContractualEmpManagementView.aspx.cs" Inherits="ContractualEmployeeManagement_UI_ContractualEmpManagementView" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"> <img src="../Report_Pages/app.png"  width="20px" /> Employee State Change List </h1>
                    </div>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Employee State Change List',
                           title: 'SMC',
                           messageTop: 'Employee State Change List',
                           exportOptions: {
              ...
              background-color: #880e4f !important;
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark" DataKeyNames="ContractualEmpManageId,EmpInfoId"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL">
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ViewReportImageButton" runat="server" class="btn btn-white btn-sm  " CommandArgument='<%#Eval("ContractualEmpManageId") %>'
                                    ...
                                    <asp:BoundField DataField="DepartmentName" HeaderText="Department" />
                                       <asp:BoundField DataField="EffectiveDate" HeaderText="Effective Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                        ...
                                        <asp:BoundField DataField="ActionStatus2" HeaderText="Status" />
                                              <asp:BoundField DataField="PendingEmp" HeaderText="Awaiting Employee" />
