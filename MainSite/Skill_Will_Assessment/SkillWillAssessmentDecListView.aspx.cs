...
public partial class Skill_Will_Assessment_SkillWillAssessmentDecListView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["masterId"]))
            {
                ...
                DataTable dtForAll = aDeclarationDal.GetJdDetailsForView(mid);
