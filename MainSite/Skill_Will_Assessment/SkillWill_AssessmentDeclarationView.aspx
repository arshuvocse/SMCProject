<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SkillWill_AssessmentDeclarationView.aspx.cs" Inherits="Skill_Will_Assessment_SkillWill_AssessmentDeclarationView" %>
                    ...
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;">
                                <img src="../Report_Pages/app.png" width="20px" /> Skill Will Assessment Declaration List</h1>
                        </div>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="KPIDeadLineMasterId" runat="server" Value='<%#Eval("SkillWillAssesDecMasId") %>' />
                                    ...
                                    <asp:TemplateField HeaderText="Report" runat="server" Visible="False">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="btn_Print" OnClick="btn_Print_OnClick"><img src="../Assets/report_magnify.png" /></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
