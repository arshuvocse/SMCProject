<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SkillWill_Assessment_Declaration.aspx.cs" Inherits="Skill_Will_Assessment_SkillWill_Assessment_Declaration" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png" width="20px"  /> Skill Will Assessment Declaration </h1>
                        </div>
                        ...
                        <div class="page-heading__container float-right d-none d-sm-block">
                            ...
                            <span class="alert alert-success"><asp:Label runat="server" ID="lastDate"></asp:Label></span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="DeclarationTextBox" autocomplete="off"  runat="server" CssClass="form-control form-control-sm" AutoPostBack="True" OnTextChanged="DeclarationTextBox_OnTextChanged"></asp:TextBox>
                        ...
                        <asp:GridView ID="gv_allocateEmp" Width="100%" CssClass="table table-bordered text-center thead-dark" AutoGenerateColumns="false" runat="server">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Dead Line">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_DeadLine" runat="server" class="form-control form-control-sm" AutoPostBack="True" OnTextChanged="txt_DeadLine_ssOnTextChanged" Text='<%#Eval("DeadLine") %>'></asp:TextBox>
