<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SkillWill_AssesmentApprovalList.aspx.cs" Inherits="Skill_Will_Assessment_SkillWill_AssesmentApprovalList" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;">
                                <img src="../Report_Pages/app.png" width="20px" /> Skill Will Assessment Approval List</h1>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:GridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gv_kpiSetup" CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="EmpSkillWillAssessmentMasterAppLogId">
                                <Columns>
