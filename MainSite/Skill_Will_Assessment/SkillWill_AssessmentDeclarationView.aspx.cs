...
public partial class Skill_Will_Assessment_SkillWill_AssessmentDeclarationView : System.Web.UI.Page
{
    ...
    {
        Session["Status"] = "Add";
        Response.Redirect("SkillWill_Assessment_Declaration.aspx");
    }
    ...
    protected void btn_View_OnClick(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SkillWillAssessmentDecListView.aspx?masterId=" + mastrId.Value + "");
    }
    ...
    protected void SearchButton_OnClick(object sender, EventArgs e)
    {
        if (companyDropDownList.SelectedValue != "")
        {
            DataTable dt = aSkillWillDal.GetSkillWillDeclarationList(" And c.CompanyId IN (" + CompanyId() + ") " + GenerateParameter() + "");
            if (dt.Rows.Count > 0)
            {
                gv_kpiSetup.DataSource = dt;
                gv_kpiSetup.DataBind();
