<%@ Page Title="" Language="C#" Debug="true" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseReimbursementFormSelfEntry.aspx.cs" Inherits="HealthCare_UI_ExpenseReimbursementFormSelfEntry" %>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header" style="display: flex; align-items: center; justify-content: space-between;">
                     ...
                     <a href="../DashBoard_UI/DashBoard.aspx" class="btn btn-sm btn-primary">Go to Home</a>
                 </div>
       ...
       <div class="row" style="padding-left:12px">
                                 <table class="table table-bordered table-striped" >
                                                    <tr>
                                                        ...
                                                        <td>  <asp:HiddenField ID="hfDateofJoinThreeMonth"  runat="server"></asp:HiddenField><asp:Label ID="ReportingLabel"  runat="server"></asp:Label></td>
                                                    </tr>
       ...
       <div class="row" style="padding-left:12px">
                                 <table class="table table-bordered table-striped" >
                                                    <tr>
                                                        ...
                                                        <td>  
                                                             <asp:TextBox runat="server"  ID="txtBankName" class="form-control form-control-sm" />
                                                        </td>

                                                        
                                                         <td  class="tblTHColorChang" style="width: 20%; padding: 10px;">Account No <span class="star">*</span></td>
                                                        <td>       <asp:TextBox runat="server"  ID="txtBankAccountNo" class="form-control form-control-sm" />
                                                         </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox runat="server"  ID="txtBranchName" class="form-control form-control-sm" />  
                                                        </td>
                                                        ...
                                                        <td>   
                                                              ...
                                                              <asp:TextBox runat="server"  ID="txtRoutingNo" class="form-control form-control-sm" />  
                                                        </td>
                                                    </tr>
...
<hr />
         ...
         <asp:TemplateField HeaderText="Document Date  <span class='star'>*</span>" >
            <ItemTemplate>
                     ...
                     <asp:TextBox ID="txtDate"   autocomplete="off" AutoPostBack="True"  OnTextChanged="Date_OnTextChanged" runat="server" CssClass="form-control form-control-sm" Text='<%# (Eval("Dates")=="" || Eval("Dates")==null) ? "0" : Eval("Dates")%>'  CausesValidation="true"></asp:TextBox>
                                            <cc1:CalendarExtender ID="CalendarExtender" runat="server" PopupPosition="TopLeft"
                                        ...
                                        <asp:TemplateField HeaderText="SI. No of Enclosed Voucher(Ref. No)  <span class='star'>*</span>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Amount (BDT) <span class='star'>*</span>" >
                                            <ItemTemplate>

                                                <asp:TextBox ID="txtRent" autocomplete="off" Text='<%# (Eval("Rent")=="" || Eval("Rent")==null) ? "0" : Eval("Rent")%>'  runat="server" CssClass="form-control form-control-sm" AutoPostBack="True" OnTextChanged="txtRent_OnTextChanged"   CausesValidation="true"></asp:TextBox>
                                         ...
                                         <asp:TemplateField HeaderText="No. of Children" >
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtChildrenNo" autocomplete="off" Text='<%# (Eval("ChildrenNo")=="" || Eval("ChildrenNo")==null) ? "0" : Eval("ChildrenNo")%>' ReadOnly='<%# !string.IsNullOrEmpty(Eval("YourConditionField") as string) 
            && (Eval("YourConditionField") as string) == "Yes" %>'  runat="server" class="form-control form-control-sm" AutoPostBack="True" OnTextChanged="txtChildrenNo_OnTextChanged"  CausesValidation="true"></asp:TextBox>
        ...
        <fieldset class="for-panel">
                                <legend>Document </legend>
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
  <label>Document Upload<span   style="color:red; " title="please fill out this field"> * </span> <span style="color: gray!important">Supported files: jpg, jpeg, png, xlsx, pdf, txt, doc, docx. Max size: 100 MB. Select a document criteria (a-e) before adding.</span></label>
                                                    <div>
  ...
  <asp:FileUpload ID="FUDocument" Visible="False" CssClass="form-control form-control-sm" runat="server"   />
     ...
     Target="_blank" ToolTip="Click to Show Document"></asp:HyperLink> 
                                ...
                                <div id="attachmentPrescriptionContainer" runat="server" class="form-group_2 attachment-criteria-item">
                                    ...
                                    <asp:RadioButton ID="CheckBox1" GroupName="AttachmentCriteria" AutoPostBack="True" OnCheckedChanged="AttachmentCriteria_OnCheckedChanged" CssClass="SelectchkChoice" style=" margin: .4rem;  font: 1rem 'Fira Sans', sans-serif;"  Text="Prescriptions" runat="server"/>
                                ...
                                <div id="attachmentBillsContainer" runat="server" class="form-group_2 attachment-criteria-item">
                                    ...
                                    <asp:RadioButton ID="CheckBox3" GroupName="AttachmentCriteria" AutoPostBack="True" OnCheckedChanged="AttachmentCriteria_OnCheckedChanged" CssClass="SelectchkChoice"  style=" margin: .4rem;  font: 1rem 'Fira Sans', sans-serif;" Text="Bills" runat="server"/>

                                </div>

                                <div id="attachmentReportsContainer" runat="server" class="form-group_2 attachment-criteria-item">

                                    <asp:RadioButton ID="CheckBox4" GroupName="AttachmentCriteria" AutoPostBack="True" OnCheckedChanged="AttachmentCriteria_OnCheckedChanged" CssClass="SelectchkChoice" style=" margin: .4rem;  font: 1rem 'Fira Sans', sans-serif;"  Text="Reports" runat="server"/>
                              ...
                              <div class="col-md-2">
                                ...
                                <div id="attachmentDischargeContainer" runat="server" class="form-group_2 attachment-criteria-item">
                                    ...
                                    <asp:RadioButton ID="CheckBox2" GroupName="AttachmentCriteria" AutoPostBack="True" OnCheckedChanged="AttachmentCriteria_OnCheckedChanged" CssClass="SelectchkChoice"   style=" margin: .4rem;  font: 1rem 'Fira Sans', sans-serif;"  Text="Discharge Paper" runat="server"/>
           ...
           $("body").on("click", "#btnUpload", function () {
               if ($("#upImage").val() != '') {
                   ...
                   if (fileInput && fileInput.files && fileInput.files.length > 0) {
                       var maxSizeBytes = 100 * 1024 * 1024; // 100 MB
                       if (fileInput.files[0].size > maxSizeBytes) {
                           alert("Attachment size exceeds limit (max 100 MB).");
                           $("#fileProgress").hide();
                           return false;
                       }
                   }
