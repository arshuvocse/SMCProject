<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ApplicationView_CommitteePanel.aspx.cs" Inherits="HealthCare_UI_ApplicationView_CommitteePanel" %>
           ...
           <div class="row" runat="server" ID="ActionBtn" Visible="False">
               ...
               <div class="col-md-3" style="padding-left: 70px">
                   <div class="card">
                      ...
                      <label ><h4 style="font-size: 15px;padding-left: 5px">Action Status</h4></label>
                  ...
                  <asp:RadioButtonList CssClass="chkChoiceHeader" ID="actionRadioButtonList" runat="server" RepeatDirection="Horizontal">
                       ...
                       <asp:ListItem Value="Draft">Reject</asp:ListItem>
                   </asp:RadioButtonList>
           ...
           <br/>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <tr>
                                      <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Bank Information</td>
                                    <td >
                                        <table class="table table-bordered table-striped" >
                                            <tr>
                                            ...
                                            <tr>
                                                        <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Bank & Branch Name </td>
                                                        <td> <asp:Label runat="server" ID="lblBranch"></asp:Label>
                                                           
                                                        </td>

                                                         <td  class="tblTHColorChang" style="width: 20%; padding: 10px;">Routing No</td>
