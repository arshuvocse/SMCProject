<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ReimbursmentFormView.aspx.cs" Inherits="HealthCare_UI_ReimbursmentFormView" %>
                 ...
                 <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            ...
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png"  width="20px" /> Expense Reimbursement Form </h1>
                        </div>
   ...
   <%--   <script>
    ...
    --%>
       <style>
           ...
           <div class="row" runat="server" ID="ActionBtn" Visible="False">
                                            ...
                                            <tr >
                                                  <td  class="tblTHColorChang" style="width: 20%; padding: 10px;">Name of Patient</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">  <asp:Label ID="Relationship"  runat="server"></asp:Label></td>
                                                    </tr>
                                            
                                            <tr>
                                                     
                                                <td  class="tblTHColorChang" style="width: 20%; padding: 10px;">Illness Description</td>
                                                <td colspan="3">  <asp:Label ID="lbl_IllnessDescription"  runat="server"></asp:Label></td>
                                            </tr>
                                    ...
                                    <tr>
                                            ...
                                            <td >
                                                ...
                                                <asp:GridView ID="loadGridView" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnPreRender="gv_DocumentUpload_PreRender"
                                                    DataKeyNames="YesNo,Date"  CssClass="AddToListCssTable">
    <Columns>
       ...
       <asp:TemplateField HeaderText="SL">
        ...
        <asp:TemplateField HeaderText="Documents">
           ...
           <div class="row" runat="server" Visible="False">
               ...
               <div class="col-md-4">
                   <asp:TextBox runat="server" ID="Comments" placeholder="If you want return, Please Comments Here" TextMode="MultiLine" Rows="2" Columns="2" CssClass="form-control "></asp:TextBox>
               </div>
               <div class="col-md-4"></div>
           ...
           <div class="col-md-4">
               ...
               <div class="col-md-4">
                  ...
                  <asp:RadioButtonList CssClass="chkChoiceHeader" ID="actionRadioButtonList" runat="server" RepeatDirection="Horizontal">
                       <asp:ListItem Selected="True" Value="Approved">Okay</asp:ListItem>
                       <asp:ListItem Value="Draft">Not Okay</asp:ListItem>
                   </asp:RadioButtonList>  

                
                   

                <label class="control-label pull-left"> <span style="font-size: 16px"> feedback</span>   <span class="star">*</span></label>
                   <br/>
                   <asp:TextBox runat="server" ID="txtFeedback" placeholder="Give your valuable feedback" TextMode="MultiLine" Rows="2" Columns="4" CssClass="form-control "></asp:TextBox>
               </div>
               <div class="col-md-4"></div>
               ...
               <div class="col-md-6">
                   <div class="form-group" style="margin-top: 17px;">
                       ...
                       <asp:LinkButton runat="server" ID="btnSubmit" OnClick="btnSubmit_OnClick"    CssClass="btn btnMyDesignSearch   btn-sm"><span aria-hidden="true" class="fa fa-check-square"></span>  &nbsp; Submit Information </asp:LinkButton>
                
                       <asp:LinkButton runat="server" ID="btnReturn" Visible="False"  OnClick="btnReturn_OnClick" CssClass="btn btnMyDesignReset   btn-sm"><span aria-hidden="true" class="fa fa-undo"></span>  &nbsp; Return Application</asp:LinkButton>
