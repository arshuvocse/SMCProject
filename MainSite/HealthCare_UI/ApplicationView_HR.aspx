<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ApplicationView_HR.aspx.cs" Inherits="HealthCare_UI_ApplicationView_HR" %>
                             ...
                             <td>
                                  <asp:GridView  ShowHeader="True" ID="gv_Member" runat="server" AutoGenerateColumns="false" CssClass="blueTableNew"   OnPreRender="gv_DocumentUpload_PreRender">
                                        ...
                                        <tr>
                                              ...
                                              <td class="tblTHColorChang"  style="width: 20%; padding: 10px;">forwarding applications from the HRD to the Doctor Comments </td>
  <td>  <asp:Label runat="server" ID="lblHRDtoDoctorComment"></asp:Label></td>
                                        </tr>
