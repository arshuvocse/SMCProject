...
public partial class HealthCare_UI_ApplicationActionChanges : System.Web.UI.Page
{
    ...
    ApplicationActionChangeDal actionChangeDal = new ApplicationActionChangeDal();
    ...
    protected void ddlCompany_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            actionChangeDal.GetDDLEmployee(ddlEmp, ddlCompany.SelectedValue);
        }
    }
    ...
    protected void ddlEmp_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            actionChangeDal.Get_Application(ddlApplication, ddlEmp.SelectedValue);
        }
    } 
}