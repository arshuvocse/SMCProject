<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="OPDIPDHeadOfExpenseView.aspx.cs" Inherits="HealthCare_UI_OPDIPDHeadOfExpenseView" %>
               ...
               var table = $('#cpFormBody_loadGridView').DataTable(
                    {
                     ...
                     ,
                            filename: 'Head Of Expense List',
                            title: 'SMC',
                            messageTop: 'Head Of Expense List',
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4],
                            }
                        }
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"> Head Of Expense List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" OnPreRender="gv_DocumentUpload_PreRender"
                                    CssClass="AddToListCssTable"  DataKeyNames="HeadOfExpenseMasterId"
                                   >
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL">
                                            <ItemTemplate>
                                                <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                 <asp:HiddenField runat="server" ID="hfHeadOfExpenseMasterId" Value='<%#Eval("HeadOfExpenseMasterId")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
