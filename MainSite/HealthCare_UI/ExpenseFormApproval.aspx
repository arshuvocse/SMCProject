<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseFormApproval.aspx.cs" Inherits="HealthCare_UI_ExpenseFormApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpFormBody" runat="Server">
            ...
            <div class="page-heading">
                <div class="page-heading__container">
                    ...
                    <h1 class="title" style="font-size: 18px; padding-top: 0px;">
                        ...
                        Expense Reimbursement Form Approval </h1>
                </div>
 ...
 <tr>
     ...
     <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Aplication Date</td>
                                            ...
                                            <tr>    
     <td class="tblTHColorChang" style="width: 20%; padding: 10px;">Balance Information</td>
                                            <td>
...
Total Balance</td>
                                                        <td>
                                                            <asp:Label runat="server" ID="txtTotalBalance"></asp:Label></td>
                                                        
                                                         <td class="tblTHColorChang" style="width: 20%; padding: 10px;">
Total Availed Amount</td>
                                                        <td>
                                                            <asp:Label runat="server" ID="txtAvailedAmount"></asp:Label></td>
                                                       
                                                         <td class="tblTHColorChang" style="width: 20%; padding: 10px;">

Remaining Balance</td>
                                                        <td>
                                                            <asp:Label runat="server" ID="RemainingBalance"></asp:Label></td>
                                                        </tr>
                                            ...
                                            <td>
                                                <table class="table table-bordered table-striped">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server" ID="Company"></asp:Label></td>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="FinancialYear" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="OfficailMobile" runat="server"></asp:Label></td>
                                            ...
                                            <td>
                                                <table class="table table-bordered table-striped">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server" ID="NameofPatient"></asp:Label></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <asp:Label ID="lbl_IllnessDescription" runat="server"></asp:Label></td>
                                                    </tr>
                            ...
                            <br />
                             <div class="row" runat="server" id="ActionBtn">
                                ...
                                <div class="col-md-2" runat="server" Visible="False">
                                    ...
                                    <label>
                                        <h4 style="font-size: 15px; padding-left: 5px">Action Status  <span class="star">*</span></h4>
                                    </label>
                                </div>

                                <div class="col-md-2"  runat="server" Visible="False">
                                    <asp:RadioButtonList CssClass="chkChoiceHeader" ID="actionRadioButtonList" runat="server" RepeatDirection="Horizontal">
                                        <%--   <asp:ListItem Value="Verified">Approved</asp:ListItem>--%>
                                    </asp:RadioButtonList>
                                </div>
                                   <div class="col-md-4">
                                       </div>
                                    ...
                                    <br/>
                                         <div class="form-row">
                                                ...
                                                <div class="ui-group-buttons">
                                                 <asp:LinkButton runat="server" ID="btnsave" OnClick="submitButton_Click" OnClientClick="return confirm('Are you sure you want to Approve ?')"  CssClass="btn btn-sm btn-info"><span aria-hidden="true" class="fa fa-check-square"></span>  &nbsp; Proceed </asp:LinkButton>  <div class="or or-sm"></div>      <asp:LinkButton ID="cancelButton"  OnClientClick="return confirm('Are you sure you want to Return ?')"    OnClick="cancelButton_OnClick" CssClass="btn btn-sm btn-danger" runat="server"  ><i class="fa fa-undo" aria-hidden="true"></i>  &nbsp;Return
</asp:LinkButton>
