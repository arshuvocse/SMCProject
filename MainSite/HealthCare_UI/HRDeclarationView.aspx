<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="HRDeclarationView.aspx.cs" Inherits="HealthCare_UI_HRDeclarationView" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">HR Decleration List</h1>
                    </div>
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                   OnPreRender="gv_DocumentUpload_PreRender"  OnRowCommand="loadGridView_RowCommand"
                                    CssClass="AddToListCssTable" DataKeyNames="HRDeclerationId"  
                                   ...
                                   >
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="OPD" HeaderText="OPD Amount" />
                                        <asp:BoundField DataField="IPD" HeaderText="IPD Amount" />                                  
