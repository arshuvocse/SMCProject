<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/MasterPages/MainMasterPage.master" enableEventValidation="false" AutoEventWireup="true" CodeFile="DocUpload.aspx.cs" Inherits="MeetingMinors_MiscellaneousInformation" %>
...
<div class="card">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList runat="server" ID="ddlSubCategory"  CssClass="form-control form-control-sm selectMe"/>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Document Entry Date</label>
                                      
                                              <asp:TextBox runat="server"  CausesValidation="true" AutoCompleteType="Disabled" class="form-control form-control-sm" ID="EfectiveDate"></asp:TextBox>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <%--https://docs.google.com/gview?url=--%>
                                                          ...
                                                          <asp:GridView Width="100%" ShowHeader="True" ID="DocumentUpload" runat="server" AutoGenerateColumns="false" CssClass="AddToListCssTable"   OnPreRender="gv_DocumentUpload_PreRender">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SL#">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex + 1%>
           ...
           <div class="col-md-12">
               <div class="form-row">
                   ...
                   <div class="col-md-8">
                         ...
                         <asp:Label runat="server" ID="lblstatus" Text="No Approval Path have been  selected." ForeColor="Red" Font-Size="17px" Visible="False"></asp:Label>
                       <br/>
                       <br/>
 ...
 &nbsp;Draft</asp:LinkButton>
                       ...
                       <asp:LinkButton ID="submitButton"  OnClick="btnSave_OnClick" Visible="False"  OnClientClick="return confirm('Are you sure you want to Submit ?')" CssClass="btn btn-sm btn-info"  runat="server">Save</asp:LinkButton>
                       
                       
                        <asp:LinkButton ID="editButton" OnClientClick="return confirm('Are you sure you want to Update ?')"  CssClass="btn btn-sm btn-info" Visible="False" runat="server" OnClick="editButton_OnClick">Update</asp:LinkButton>
