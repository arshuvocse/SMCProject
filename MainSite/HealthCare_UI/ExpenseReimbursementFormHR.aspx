<%@ Page Title="" Language="C#" Debug="true" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseReimbursementFormHR.aspx.cs" Inherits="HealthCare_UI_ExpenseReimbursementFormHR" %>
  ...
  <label class="form-check-label" for="inlineRadio2">OPD</label>
   ...
   <div class="form-row" >
       <div class="col-md-3">
         ...
         <div class="col-md-9">
             <a href="../DownloadsForm/User%20Manual%20Healthcare.pdf"  target="_blank" class="btn btnMyDesignAddtoList pull-right" title="Click to download Health Care User Manual">Health Care User Manual</a>
             </div>
   </div>     
   <hr />
               ...
               <div class="col-md-5">
                ...
                <div class="col-md-3">
                                        <div class="form-group" style="margin-top: 17px;">
                                             <asp:LinkButton runat="server" ID="drrft"  OnClick="drrft_OnClick" Visible="False"   CssClass="btn btnMyDesignAddtoList   btn-sm"><span aria-hidden="true" class="fa fa-check-square"></span>  &nbsp; Draft </asp:LinkButton>
