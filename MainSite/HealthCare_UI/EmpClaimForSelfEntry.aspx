<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmpClaimForSelfEntry.aspx.cs" Inherits="HealthCare_UI_EmpClaimForSelfEntry" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"> Claim For </h1>
                    </div>
                    ...
                    <div class="card">
                             ...
                             <div class="row">
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label>First Children Name </label>
                                        <label style="color: #a52a2a">*</label>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label>Second Children Name </label>
                                        <label style="color: #a52a2a">*</label>
