...
public partial class HealthCare_UI_HRPanelForAllBill : System.Web.UI.Page
{
    ...
    private void LoadInitialDDL()
    {
        ...
        try
        {
            ...
            using (DataTable dt = _commonDataLoad.GetCompanyDDL2())
            {
    ...
    
    {
        try
        {
            ...
            DataTable DtNormal = aPanelDal.Get_HRPanelForAllBill(Parameter());
            if (DtNormal.Rows.Count > 0)
            {

                gv_JdBoard.DataSource = DtNormal;
                gv_JdBoard.DataBind();

                gv_Export.DataSource = DtNormal;
                gv_Export.DataBind();
            }
