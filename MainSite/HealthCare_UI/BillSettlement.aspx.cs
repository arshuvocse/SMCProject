...
public partial class HealthCare_UI_BillSettlement : System.Web.UI.Page
{
    ...
    protected void save_onclick(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            aSettlement.ReimbursFromMasterId = Convert.ToInt32(hfReimbursmentFormId.Value);
            ...
            if (IPD.Checked)
            {
                aSettlement.PayableFrom = IPD.Text;
            }

            if (OPD.Checked)
            {
                aSettlement.PayableFrom = OPD.Text;
            }

            if (Speical.Checked)
            {
                aSettlement.PayableFrom = Speical.Text;
              //  aSettlement.OtherBalance = Convert.ToDecimal(OtherBalance.Text);
            ...
            {
                aSettlement.AddvanceTK = Convert.ToDecimal(lblAdvanceBal.Text);
                
            }
            aSettlement.IsExtraAllocate = (isExtra.Checked);


            if (hfTotalRemainingBlnc.Value != "")
            {
                aSettlement.RemaiingBlnce = Convert.ToDecimal(hfTotalRemainingBlnc.Value);

            }
            aSettlement.CurrentBlnce = Convert.ToDecimal(RemainBalance.Text);
            ...
            Int32 rei = aSettlementDal.data_save(aSettlement, DocAlist);
