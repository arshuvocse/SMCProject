...
public partial class HealthCare_UI_CommitteeSetupView : System.Web.UI.Page
{
    ...
    {
        DataTable dataTable = aCommitteSetupDal.Get_CommitteeSetup();
    ...
    {
        Response.Redirect("CommiteeSetup.aspx");
    }
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "CommitteeSetupEdit")
        {
            ...
            if (datKey != null)
            {
                ...
                Response.Redirect("CommiteeSetupEdit.aspx?MID=" + MId);
            }
        }
    }
