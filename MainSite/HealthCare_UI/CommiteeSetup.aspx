<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="CommiteeSetup.aspx.cs" Inherits="HealthCare_UI_CommiteeSetup" %>
               ...
               <div class="col-md-12">
                     ...
                     <div class="form-group ">
                          ...
                          <div class="row">
                                ...
                                <div class="col-md-4"> <asp:DropDownList ID="ddlCompany" runat="server"  class="form-control form-control-sm" ></asp:DropDownList> </div>
                            </div>
