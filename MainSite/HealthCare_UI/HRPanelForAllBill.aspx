<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" EnableEventValidation = "false" CodeFile="HRPanelForAllBill.aspx.cs" Inherits="HealthCare_UI_HRPanelForAllBill" %>
...
<%--                                             <asp:ListItem value="Draft">  
  ...
  <script>
     ...
     <ItemTemplate>
         <asp:Label ID="ApprovedDate" runat="server"   Text='<%# Eval("ApprovedDate", "{0:d-MMM-yyyy}") %>'>></asp:Label>
                             ...
                             <asp:TemplateField HeaderText="View" HeaderStyle-CssClass="no-export">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Change Payment" HeaderStyle-CssClass="no-export" Visible="False">
                                        <ItemTemplate>
 ...
 ><%#Eval("ForwardtoDoctor") %>
                                    ...
                                    <asp:TemplateField HeaderText="View Committee Feedback" HeaderStyle-CssClass="no-export">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Application Return" HeaderStyle-CssClass="no-export" Visible="False">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="HR Reject" HeaderStyle-CssClass="no-export" Visible="False">
                                        <ItemTemplate>
                             ...
                             <%--       <asp:TemplateField HeaderText="Set KPI" Visible="False">
                               ...
                               <%--     <asp:TemplateField HeaderText="Approval Status">
                                    ...
                                    <asp:BoundField DataField="HeadofDptDate" HeaderText="HoD Approved Date" />
                                    <asp:BoundField DataField="ForwardtoDoctorDate" HeaderText="Doctor's Recommendation Date" />
                                    <asp:BoundField DataField="FinalApproveDate" HeaderText="Approve Date" />
                                    <asp:BoundField DataField="CommeApprovedDate" HeaderText="Committee Approve Date" />

                                    <asp:TemplateField HeaderText="Forward to Doctor">
                                        <ItemTemplate>
                                            <asp:Label ID="ForwardtoDoctor" runat="server" Text='<%#Eval("ForwardtoDoctor") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Forward To MD">
                                        <ItemTemplate>
                                            <asp:Label ID="ForwardToMD" runat="server" Text='<%#Eval("MDApproval") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
