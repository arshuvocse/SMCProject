...
public partial class HealthCare_UI_ExpenseReimbursementFormHR : System.Web.UI.Page
{
    ...
    protected void onRecord(Int32 id)
    {
        ...
        if (dtMaster.Rows.Count > 0)
        {
           ...
           txtBankAccountNo.Text = dtMaster.Rows[0]["BankAccountNo"].ToString(); ;
            ...
            {
                load_IPD_OPD(1, ddlCompany.SelectedValue, hfEmpID.Value, dtMaster.Rows[0]["Type"].ToString());
            }
            else
            {
    ...
    private void LoadInitialDDL()
    {
        ...
        using (DataTable dt = _commonDataLoad.GetCompanyDDL())
        {
            ...
            load_IPD_OPD(0, ddlCompany.SelectedValue, hfEmpID.Value,inlineRadio.SelectedValue);
    ...
    private void Submit(string Action)
    {
        if (Validation())
        {
            ...
            aMaster.EmpInfoId = int.Parse(ddlForwordEmp.SelectedValue);
    ...
    protected void inlineRadio_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (inlineRadio.SelectedValue == "Special")
        {
            ...
            if (ddlCompany.SelectedValue != "")
            {
                load_IPD_OPD(0, ddlCompany.SelectedValue, hfEmpID.Value, "OPD");
            }
        }
        ...
        if (inlineRadio.SelectedValue == "OPD")
        {
            ...
            if (ddlCompany.SelectedValue != "")
            {
                load_IPD_OPD(1, ddlCompany.SelectedValue, hfEmpID.Value, "OPD");
            }
        }
