...
public partial class HealthCare_UI_SpecialApproval : System.Web.UI.Page
{
    ...
    {
        DataTable dt = aDal.Get_DataListForFormApproval_Special();
        if (dt.Rows.Count > 0)
        {
    ...
    protected void btnView_OnClick(object sender, EventArgs e)
    {
        ...
        Session["MDReturn"] = "";
        Session["MDReturn"] = "MDReturn";

        Response.Redirect("ExpenseFormMDApproval.aspx?MID=" + EmpId + "&ForEmpId=" + ForEmpId + "");
    }
}