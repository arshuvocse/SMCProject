<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseReimbursementFormEntry.aspx.cs" Inherits="HealthCare_UI_ExpenseReimbursementFormEntry" %>
               ...
               <div class="col-md-12">
                     ...
                     <div class="form-group ">   
                          ...
                          <div class="row">
                                ...
                                <div class="col-md-4"> <asp:DropDownList ID="ddlFinancialYear" AutoPostBack="True" OnSelectedIndexChanged="ddlFinancialYear_OnSelectedIndexChanged" runat="server"  class="form-control form-control-sm" ></asp:DropDownList> </div>
                            </div>
                          ...
                          <div class="row">
                                ...
                                <div class="col-md-4" style="padding-top:8px">
                                     ...
                                     <div class="form-check form-check-inline" >
   <asp:RadioButton  CssClass="form-check-input" ID="inlineRadio1" value="option1" name="inlineRadioOptions" AutoPostBack="True" OnCheckedChanged="IPD_Click" Checked="True"  runat="server"/>  
                     ...
                     <div class="form-group ">                                                    
                           ...
                           <div style="padding-top: 5px;"></div>
                            <div class="row">
                                ...
                                <div class="col-md-6">  <asp:TextBox runat="server"    ID="Relationship"  class="form-control form-control-sm" /></div>
                            </div>                     
                       </div>
                   </div>       
  ...
  <div class="form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:CheckBox ID="Prescription" Text="PhotocCopy of the Prescription" runat="server"/>

                                </div>

                                <div class="form-group">

                                    <asp:CheckBox ID="BillofConsaltation" Text="Original Bill of Consaltation" runat="server"/>

                                </div>
                                
                                <div class="form-group">

                                    <asp:CheckBox ID="BillofMedicine" Text="Original Bill of Medicine" runat="server"/>

                                </div>

                                <div class="form-group">

                                    <asp:CheckBox ID="BillofHospitalization" Text="Original Bill of Hospitalization" runat="server"/>

                                </div>
                                
                                <div class="form-group">

                                    <asp:CheckBox ID="SpecialDocumentUpload" Text="Special Allowance Approval Documents" runat="server"/>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:CheckBox  CssClass="clsCheckls" ID="BillofInvestigation" Text="Original Bill of Investigation" runat="server"/>

                                </div>

                                <div class="form-group">

                                    <asp:CheckBox ID="PhotoCopyofInvestigation" Text="PhotoCopy of Investigation" runat="server"/>

                                </div>
                                
                                <div class="form-group">

                                    <asp:CheckBox ID="BillForCharges" Text="Original Bill For Charges" runat="server"/>

                                </div>

                                <div class="form-group">

                                    <asp:CheckBox ID="Other" Text="Other" runat="server"/>
...
<hr />
 ...
 <%-- <table class="table table-bordered dataTable dtr-inline">
  <tr>
    <th rowspan="2">Particullers</th>
    <th colspan="4">Claim Details</th> 
  </tr>
  <tr>
    <th>Date(s)</th>
    <th>Sl. No Of Enclosed Vouchers</th>
    <th>Amount(BDT)</th>
    <th>Total(BDT)</th>
    <th>Action</th>
  </tr>
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td style="text-align: center"><img src="../Assets/plus-sign.png" /> &nbsp;&nbsp; <img src="../Assets/minus-sign.png" /></td>
  </tr>
  
  <tr>
    <td>Medicine/laboratory Items/Accessories</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
   ...
   <tr>
    <td>Investigation/Pathogoly & Procedural Charges</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
   ...
   <tr>
    <td colspan="3">Grant Total(BDT)</td>
    <td></td>
    <td></td>
    <td style="text-align: center"><img src="../Assets/plus-sign.png" /> &nbsp;&nbsp; <img src="../Assets/minus-sign.png" /></td>
       ...
       --%>
               ...
               <div id="gridContainer2" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="GridView1" runat="server" ShowFooter="True"  AutoGenerateColumns="False"    DataKeyNames="Amount" CssClass="blueTableNew"   OnPreRender="gv_DocumentUpload_PreRender">
                                    <Columns>
         ...
         <asp:TemplateField HeaderText="Date(s)" >
            <ItemTemplate>
                     ...
                     <asp:TextBox ID="Date" runat="server" class="form-control form-control-sm" Text='<%# (Eval("Dates")=="" || Eval("Dates")==null) ? "0" : Eval("Dates")%>'  CausesValidation="true"></asp:TextBox>
                                            <cc1:CalendarExtender ID="CalendarExtender" runat="server" PopupPosition="TopLeft"
                                                Format="dd-MMM-yyyy" PopupButtonID="ImageButtosn1" CssClass="MyCalendar"
                                                TargetControlID="Date" />
              ...
              <asp:TemplateField HeaderText="SI. No of Enclosed Voucher">
                     <ItemTemplate>
                          <asp:TextBox ID="Voucher" runat="server" Text='<%# (Eval("SINoOfEncloseVoucher")=="" || Eval("SINoOfEncloseVoucher")==null) ? "0" : Eval("SINoOfEncloseVoucher")%>'  CssClass="form-control form-control-sm"></asp:TextBox>
                     </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Amount (BDT)">
                     <ItemTemplate>
                          <asp:TextBox ID="Amount" runat="server" Text='<%# (Eval("Amount")=="" || Eval("Amount")==null) ? "0" : Eval("Amount")%>' OnTextChanged="Amount_OnTextChanged" AutoPostBack="True"   CssClass="form-control form-control-sm"></asp:TextBox>
       ...
       <hr />
        ...
        <div class="row" style="padding-top:10px" runat="server" Visible="True">
                 <div class="col-md-12">
