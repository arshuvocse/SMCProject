<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ExeOfficeDocSubCateView.aspx.cs" Inherits="HealthCare_UI_ExeOfficeDocSubCateView" %>
               ...
               var table = $('#cpFormBody_loadGridView').DataTable(
                    {
                     ...
                     ,
                            filename: 'Executive Document Subcategory list',
                            title: 'SMC',
                            messageTop: 'Executive Document Subcategory list',
                            exportOptions: {
                                columns: [0, 2, 3, 4, 5, 6]
                            }
                        }
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <span></span>
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">Executive Office Document SubCategory List</h1>
                    </div>
                    ...
                    <div class="card" >
                       ...
                       <%--     <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">--%>
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    ...
                                    CssClass="AddToListCssTable"  DataKeyNames="ExeOfficeDocSubCatId"  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ExeOfficeDocCategory" HeaderText="Executive Office Document Category" />
                                        <asp:BoundField DataField="ExeOfficeDocSubCate" HeaderText="Executive Office Document SubCategory" />
