<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeePromotionEdit.aspx.cs" Inherits="Transfer_UI_EmployeePromotionEdit" %>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>Search Employee: </label>
                                                             ...
                                                             <asp:DropDownList Enabled="False"  runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEmpInfo_OnSelectedIndexChanged"  ID="ddlEmpInfo" class="form-control form-control-sm" />
