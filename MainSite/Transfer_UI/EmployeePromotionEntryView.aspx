<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeePromotionEntryView.aspx.cs" Inherits="Transfer_UI_EmployeePromotionEntryView" %>
                             ...
                             <div class="form-row">
                                  ...
                                  <div  class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtSearch" runat="server" Visible="False" AutoPostBack="True" placeholder=" Search Single Employee" CssClass="form-control form-control-sm"
              ...
              background-color: #880e4f !important;
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark" DataKeyNames="EmployeePromotionEntryId, IsPromotion, EmployeeId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Print">
                                         ...
                                         <asp:TemplateField HeaderText="Print Letter">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="VisitingLetterImageButton" runat="server" class="btn btn-white btn-sm  " CommandArgument='<%#Eval("EmployeePromotionEntryId") %>' 
