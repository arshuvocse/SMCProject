<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmpTransferAndRedesignationApprovalList.aspx.cs" Inherits="Transfer_UI_EmpTransferAndRedesignationApprovalList" %>
            ...
            <div class="divWaiting">
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"><img src="../Report_Pages/app.png"  width="20px" />&nbsp;Employee Transfer Approval List </h1>
                    </div>
                            ...
                            <div class="form-row" runat="server" Visible="False">
                                ...
                                <div class="col-md-3" style="margin-top: 18px;">
                                    <div class="form-group" >
                                        ...
                                        <asp:LinkButton runat="server" ID="SearchButton" OnClick="SearchButton_OnClick"  ToolTip="Click To Search"    class="btn btn-info btn-sm" ><span aria-hidden="true" class="fa fa-search-plus"></span>  &nbsp;Search</asp:LinkButton>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Employee Transfer List',
                           title: 'SMC',
                           messageTop: 'Employee Transfer List',
                           exportOptions: {
              ...
              background-color: #880e4f !important;
                              ...
                              <div id="gridContainer1" style="height: auto; overflow: auto; width: auto;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered  text-center thead-dark" DataKeyNames="EmpTransferAndRedesignationId,EmployeeId,EmpTransferAndRedesignationAppLogAppLogId"
                                    ...
                                    <Columns>
                                     ...
                                     <%--     <asp:TemplateField HeaderText="Report">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ViewReportImageButton" runat="server" class="btn btn-white btn-sm  " CommandArgument='<%#Eval("EmpTransferAndRedesignationId") %>'
                                    ...
                                    <asp:BoundField DataField="IsOnlyTransfer" HeaderText="Company To Company Transfer" />
                                  
                                    <asp:BoundField DataField="IsInterCompanyTransfer" HeaderText="Inter Company Transfer" />
