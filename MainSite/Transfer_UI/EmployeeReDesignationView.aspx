<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeReDesignationView.aspx.cs" Inherits="Transfer_UI_EmployeeReDesignationView" %>
            ...
            <div class="divWaiting">
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;"><img src="../Report_Pages/app.png"  width="20px" />&nbsp;Employee Re-Designation List </h1>
                    </div>
              ...
              var table = $('#cpFormBody_loadGridView').DataTable(
                   {
                    ...
                    ,
                           filename: 'Employee Re-Designation List',
                           title: 'SMC',
                           messageTop: 'Employee Re-Designation List',
                           exportOptions: {
                        ...
                        <div class="card-body">
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered text-center thead-dark" DataKeyNames="EmployeeReDesignationId,  EmployeeId"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL">
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ViewReportImageButton" runat="server" class="btn btn-white btn-sm  " CommandArgument='<%#Eval("EmployeeReDesignationId") %>'
                                                        CommandName="Preview" ImageUrl="~/Assets/report_magnify.png" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                         <asp:TemplateField HeaderText="Print Letter"  Visible="False">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="VisitingLetterImageButton" runat="server" class="btn btn-white btn-sm  " CommandArgument='<%#Eval("EmployeeReDesignationId") %>' 
                                  ...
                                  <%--  <asp:BoundField DataField="PDesignation" HeaderText="Designation" />--%>
                                    <asp:BoundField DataField="DepartmentName" HeaderText="Department" />
                                        <asp:BoundField DataField="PDesignation" HeaderText="Previous Designation" />
