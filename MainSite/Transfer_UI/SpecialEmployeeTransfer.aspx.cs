...
public partial class HealthCare_UI_SpecialEmployeeTransfer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
          //  ButtonVisible();
            ...
            allowanceCancelDal.LoadCompany(ddlToCompany);
            companyDropDownList.SelectedIndex = 1;
            companyDropDownList_OnSelectedIndexChangedanyDropDownList_OnSelectedIndexChanged(null, null);
            if (Session["MId"] != null)
            {
    ...
    protected void companyDropDownList_OnSelectedIndexChangedanyDropDownList_OnSelectedIndexChanged(object sender, EventArgs e)
    {
