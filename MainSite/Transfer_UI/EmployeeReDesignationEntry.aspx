<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeReDesignationEntry.aspx.cs" Inherits="Transfer_UI_EmployeeReDesignationEntry" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">   <img src="../Report_Pages/app.png"  width="20px" />&nbsp;Employee Re-Designation Information </h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                                        ...
                                                        <fieldset class="for-panel">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6" >
                                                                    ...
                                                                    <div class="form-group" runat="server" runat="server" Visible="False">
                                                            ...
                                                            FirstRowSelected="false">
                                                                    ...
                                                                    <div class="form-group" runat="server" Visible="False">
                                                                      ...
                                                                      <div class="form-group" runat="server" Visible="False">
                                                                          ...
                                                                          <asp:CheckBox ID="Chkreappointment" Text="Reappointment" runat="server" />
                                                                    ...
                                                                    <div class="form-group">
                                                                        <asp:Label runat="server" ID="Label13">Remarks </asp:Label>  <span style="color: red">&nbsp;*</span>
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 ">
                                            <asp:CheckBox ID="manualUpdateCheckBox" Enabled="False" Checked="True" runat="server" />
