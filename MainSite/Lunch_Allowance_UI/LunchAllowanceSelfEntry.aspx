<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainMasterPage.master" CodeFile="LunchAllowanceSelfEntry.aspx.cs" Inherits="Lunch_Allowance_UI_LunchAllowanceSelfEntry" EnableEventValidation="false" %>
            ...
            <div class="page-heading">
                ...
                <div class="page-heading__container float-right d-none d-sm-block" runat="server">
                    ...
                    <div runat="server" visible="False">
                        <asp:LinkButton ID="btn_New" Style="font-style: normal!important; font-weight: bold" CssClass="btn btn-sm btn-outline-success " runat="server" OnClick="btn_New_OnClick"> <i class="fa fa-backward"></i>&nbsp;Back to List</asp:LinkButton></div>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-row" style="padding-right: 10px" runat="server" visible="False">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField Visible="False">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:CheckBox Checked="True" ID="txt_check" runat="server"></asp:CheckBox>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="From Date">
                                                <ItemTemplate>
                                                   ...
                                                   <%--  <cc1:CalendarExtender ID="CalendarExtender32" runat="server"
                                                                                        Format="dd-MMM-yyyy" PopupButtonID="txt_fromDate" CssClass="black"
                                            ...
                                            <asp:TemplateField HeaderText="Inactive Date" Visible="False">
                                                <ItemTemplate>
                                ...
                                <div class="form-row">
                                    <div class="col-2">
                                        <div class="form-group">
                                            <asp:HiddenField runat="server" ID="hfToDate" />
                                            <asp:HiddenField runat="server" ID="hfFromDate" />
