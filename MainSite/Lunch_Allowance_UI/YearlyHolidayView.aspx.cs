...
public partial class Lunch_Allowance_UI_YearlyHolidayView : System.Web.UI.Page
{
    ...
    private void LoadRegionInformation()
    {
        try
        {
            DataTable dataTable = commmDAl.GetVacanceyEntryformationParam(" and  hol.CompanyId IN (" + CompanyId() + ")");
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            Response.Redirect("YearlyHolidayEntry.aspx");
        }
