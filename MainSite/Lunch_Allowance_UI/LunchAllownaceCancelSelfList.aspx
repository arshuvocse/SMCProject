<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="LunchAllownaceCancelSelfList.aspx.cs" Inherits="Lunch_Allowance_UI_LunchAllownaceCancelSelfList" %>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js"></script>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">  <img src="../Report_Pages/app.png"  width="20px" /> Lunch Cancel List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;" >
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                    CssClass="table table-bordered text-center thead-dark table-hover table-striped" DataKeyNames="LunchAlllowCancelId,EmpInfoId,EffectiveDate,ActionStatus, Checkk" ShowFooter="True"
                                ...
                                <asp:TemplateField HeaderText="Department">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="EffectiveDate" HeaderText="Cancel Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                       ...
                                       <%-- <asp:BoundField DataField="ActionStatus" HeaderText="Action Status" /> 
                                        ...
                                        <asp:TemplateField HeaderText="Action Status">
                                            <ItemTemplate>
                                                <asp:Label ID="txt_ActionStatus" runat="server"  Text='<%#Eval("ActionStatus") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton runat="server" ID="btnEdit" Visible="True"  OnClick="btnEdit_OnClick"  CssClass="btn btn-sm btnMyDesignEdit"><i class="fa fa-edit"></i> </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
