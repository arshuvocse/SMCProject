<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="LunchForGuestIntern.aspx.cs" Inherits="Lunch_Allowance_UI_LunchForGuestIntern" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">  <img src="../Report_Pages/app.png"  width="20px" /> Guest / Intern Information  </h1>
                    </div>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-4">
                                        ...
                                        <span style="color: red">&nbsp;*</span>  
                                                 <asp:DropDownList ID="rbTransferType"  class="form-control form-control-sm"    runat="server"   AutoPostBack="True" OnSelectedIndexChanged="rbTransferType_OnSelectedIndexChanged">
                                          <%--  <asp:ListItem Selected="True" Value="Guest" >Guest  </asp:ListItem>
                                            <asp:ListItem Value="Intern">Internship</asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                        <div class="form-group">
                                        <label>Name </label>
                                        <span style="color: red">&nbsp;*</span>
                                      <asp:TextBox runat="server" ID="txtName"  class="form-control form-control-sm"></asp:TextBox>
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                        <label>Lunch From Date </label> <span style="color: red">&nbsp;*</span>
                                     ...
                                     <div class="form-group">
                                        <label>Lunch To Date </label> <span style="color: red">&nbsp;*</span>
                                       ...
                                       <asp:TextBox ID="txtToDate" AutoCompleteType="Disabled" runat="server"     CausesValidation="true" 
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server"
                                         ...
                                         <div class="form-group" runat="server" Visible="False" id="divReff">
                                        <label>Referance Person  </label>
                                        <span style="color: red">&nbsp;*</span>
                                      ...
                                      <asp:TextBox runat="server" ID="txtRemarks"  class="form-control form-control-sm"></asp:TextBox>
                                       ...
                                       <div class="form-group" style="margin-top: 18px;">
                                         ...
                                         <asp:LinkButton runat="server" ID="Button1" OnClick="Button1_OnClick"   Width="80" Text="Search" class="btn btn-info btn-sm" >   &nbsp; Submit </asp:LinkButton>      &nbsp;&nbsp;
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="lblDateData" AutoCompleteType="Disabled" runat="server"   CausesValidation="true" 
                                            class="form-control form-control-sm"  ReadOnly="True" Text='<%#Eval("EffectiveDate", "{0:dd-MMM-yyyy}") %>'></asp:TextBox>
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtenderuu2" runat="server"
                                            ...
                                            TargetControlID="lblDateData" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Approval Remarks" Visible="False">
                                                        <ItemTemplate>
