...
public partial class Lunch_Allowance_UI_LunchForGuestInternList : System.Web.UI.Page
{
    ...
    private void LoadRegionInformation()
    {
        try
        {
            DataTable dataTable = commmDAl._GuestListView(" ");
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "DeleteData")
        {
            int rowindex = Convert.ToInt32(e.CommandArgument);
            string VacancyCirculationId = loadGridView.DataKeys[rowindex][0].ToString();
          //  string name = loadGridView.DataKeys[rowindex][1].ToString();
            //DataTable dataTable = aVaencyEntryDaL.checkGuestList(name);
