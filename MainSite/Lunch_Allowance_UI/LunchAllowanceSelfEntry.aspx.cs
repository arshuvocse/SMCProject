...
public partial class Lunch_Allowance_UI_LunchAllowanceSelfEntry : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dtuserpermission.Rows.Count > 0)
            {
                    ...
                    dtuserpermission.Rows[0]["UserTypeId"].ToString() != "4")
                {
                    ...
                    gv_EmpInfoLoad.Columns[gv_EmpInfoLoad.Columns.Count - 1].Visible =
                        Convert.ToBoolean(ViewState["View"].ToString());
                    gv_EmpInfoLoad.Columns[gv_EmpInfoLoad.Columns.Count - 2].Visible =
                        Convert.ToBoolean(ViewState["Delete"].ToString());
                    gv_EmpInfoLoad.Columns[gv_EmpInfoLoad.Columns.Count - 3].Visible =
    ...
    private void LoadEMPInfo()
    {
        ...
        jobCreationInfos = _userCommonDal.GetEMpInfosForLunchAllowance(GenerateParameter(), Session["CompanyId_nnnn"].ToString());
        if (jobCreationInfos.Rows.Count>0)
        {
            ...
            try
            {
                for (int i = 0; i < gv_EmpInfoLoad.Rows.Count; i++)
                {
                    ...
                    {
                        ddlStatus_chang(i);
                        ((CalendarExtender)gv_EmpInfoLoad.Rows[i].FindControl("CalendawrExaqwtender1")).StartDate = DateTime.Now.AddDays(1);
                        ((CalendarExtender)gv_EmpInfoLoad.Rows[i].FindControl("CalendarExstdaender1")).StartDate = DateTime.Now.AddDays(1);
                        ((CalendarExtender)gv_EmpInfoLoad.Rows[i].FindControl("CalendawqewrExstender1")).StartDate = DateTime.Now.AddDays(1);
                      
                        try
                        {
                            ((CheckBox)gv_EmpInfoLoad.Rows[i].FindControl("txt_check")).Checked = true;
                        ...
                        try
                        {
                            ...
                            hfFromDate.Value = jobCreationInfos.Rows[i].Field<string>("AllowFromDate").ToString();
                        }
                        catch (Exception)
                        {
                        ...
                        try
                        {
                            ...
                            hfToDate.Value = jobCreationInfos.Rows[i].Field<string>("AllowToDate").ToString();
    ...
    private string GenerateParameter()
    {
        ...
        parameter = parameter + "  and    e.CompanyId = '" + Session["CompanyId_nnnn"].ToString() + "'";
        ...
        {
            parameter = parameter + "  and  e.EmpInfoId=" + Session["EmpInfoId"].ToString() + "";
        }
    ...
    protected void ddlCompany_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        { 
            ...
            using (DataTable dt222 = _commonDataLoad.GetEmpDDLIsActive(ddlCompany.SelectedValue.ToString()))
            {
                ...
                try
                {
                    ddlEmpInfo.SelectedValue = Session["EmpInfoId"].ToString();
                }
                catch (Exception)
                {
                            ...
                            for (int i = 0; i < gv_EmpInfoLoad.Rows.Count; i++)
                            {
                              ...
                              tblLunchAllowDetail UpEmp = (from j in db.tblLunchAllowDetails where j.EmployeeId == NewEmpIdUp select j).FirstOrDefault();
                                    ...
                                    if (UpEmp != null)
                                    {
                                        ...
                                        Label txt_empId = (Label)gv_EmpInfoLoad.Rows[i].FindControl("txt_empId");
                                        Label txt_name = (Label)gv_EmpInfoLoad.Rows[i].FindControl("txt_name");
                                        Label txt_DivisionName = (Label)gv_EmpInfoLoad.Rows[i].FindControl("txt_DivisionName");
                                        Label txt_dptName = (Label)gv_EmpInfoLoad.Rows[i].FindControl("txt_dptName");
                                        Label txt_designation = (Label)gv_EmpInfoLoad.Rows[i].FindControl("txt_designation");
                                        ...
                                        SenMailForApprved(Convert.ToInt32(920), "Employee lunch activation", @"  <br/> Dear Sir, <br/>
Employee ID: " +txt_empId.Text+@" <br/>
Employee Name: " + txt_name.Text + @"<br/>
Division:" + txt_DivisionName.Text + @"<br/>
Department:" + txt_dptName.Text + @"<br/>
From Date:" + txt_fromDate.Text + @"<br/>
To Date:" + txt_ToDate.Text + @"<br/><br/><br/>
 please login for the details from the below link.<br/>  https://hris.smc-bd.org/ <br/>
Thank You.
");

                                        SenMailForApprved(Convert.ToInt32(1393), "Employee lunch activation", @"  <br/> Dear Sir, <br/>
Employee ID: " + txt_empId.Text + @" <br/>
Employee Name: " + txt_name.Text + @"<br/>
Division:" + txt_DivisionName.Text + @"<br/>
Department:" + txt_dptName.Text + @"<br/>
...
");
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(),
                        "alert",
                        "alert('Operation Successful...! ');window.location ='LunchAllowanceSelfEntry.aspx';",
                        true);
                }
            }
            catch (Exception)
    ...
    private bool Validations()
    {
        ...
        for (int i = 0; i < gv_EmpInfoLoad.Rows.Count; i++)
        {
            ...
            if ((ddlStatus.SelectedValue == "Active") && (chkBoxRows.Checked == true))
            {
                ...
                if (txt_DeadLine.Text != "")
                {
                    if (hfFromDate.Value == txt_DeadLine.Text)
                    {
                        AlertMessageBoxShow("Please Change From Date...");
                        txt_DeadLine.Focus();
                ...
                if (txt_ToDate.Text != "")
                {
                    if (hfToDate.Value == txt_ToDate.Text)
                    {
                        AlertMessageBoxShow("Please Change To Date...");
                        txt_ToDate.Focus();
