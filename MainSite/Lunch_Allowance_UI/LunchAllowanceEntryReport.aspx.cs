...
public partial class Lunch_Allowance_UI_LunchAllowanceEntryReport : System.Web.UI.Page
{
    ...
    private void LoadEMPInfo()
    {
        ...
        jobCreationInfos = _userCommonDal.GetEMpInfosForLunchAllowanceDelLog(GenerateParameter(), ddlCompany.SelectedValue);
