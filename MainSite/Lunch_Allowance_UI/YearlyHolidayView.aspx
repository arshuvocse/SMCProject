<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="YearlyHolidayView.aspx.cs" Inherits="Lunch_Allowance_UI_YearlyHolidayView" %>
 ...
 <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/dataTables.buttons.min.js"></script>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js"></script>
                ...
                <script>
                        ...
                        var table = $('#cpFormBody_loadGridView').DataTable(
                             {
                              ...
                              ,
                                     filename: 'Guest / Intern Information ',
                                     title: 'SMC',
                                     messageTop: 'Guest / Intern Information ',
                                     exportOptions: {
                    ...
                    Sys.WebForms.PageRequestManager.getInstance().add_endRequest(table);
      </script>
                ...
                <div class="page-heading">
                    <div class="page-heading__container">
                        ...
                        <h1 class="title" style="font-size: 18px; padding-top: 9px;">  <img src="../Report_Pages/app.png"  width="20px" />  Yearly Holiday List</h1>
                    </div>
                        ...
                        <div class="card-body" >
                            ...
                            <div id="gridContainer1" style="height: auto; overflow: auto; width: auto; overflow-y: scroll; overflow-x: scroll;" >
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                      CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender"   DataKeyNames="YearlyHolidayId"  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ShortName" HeaderText="Company" />
                                          ...
                                          <asp:BoundField DataField="YearlyHolidayFromDate" HeaderText="Yearly Holiday From Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                          <asp:BoundField DataField="YearlyHolidayToDate" HeaderText="Yearly Holiday To Date" DataFormatString="{0:dd-MMM-yyyy}" />
