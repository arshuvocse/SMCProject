<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainMasterPage.master" CodeFile="InterviewCandidateInvitation.aspx.cs" Inherits="Inverview_InterviewCandidateInvitation" %>
                ...
                <div class="container-fluid">
                    <div class="page-heading">
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"><img src="../Report_Pages/app.png" width="20px"  /> Interview Candidate Invitation</h1>
                        </div>
...
<%--                                <div class="col-3">
                           ...
                           <asp:LinkButton runat="server" ID="btn_LoadList" OnClick="btn_LoadList_OnClick" CssClass="btn btn-sm btnMyDesignSearch"><i class="fa fa-search-plus"></i>&nbsp; Search Matching Candidate List</asp:LinkButton>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField runat="server" ID="hdpkd" Value='<%#Eval("CandidateInvitationId") %>' />
                                        ...
                                        <asp:TemplateField HeaderText="Phone">
                                            <HeaderTemplate>
                                                <asp:CheckBox runat="server" ID="chkAllPhone" Text="Phone" AutoPostBack="True" OnCheckedChanged="chkAllPhone_OnCheckedChanged"/>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="chkSinglePhone" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Email">
                                            <HeaderTemplate>
                                                <asp:CheckBox runat="server" ID="chkAllEmail" Text="Email" AutoPostBack="True" OnCheckedChanged="chkAllEmail_OnCheckedChanged"/>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="chkSingleEmail" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="SMS">
                                            <HeaderTemplate>
                                                <asp:CheckBox runat="server" ID="chkAllSMS" Text="SMS" AutoPostBack="True" OnCheckedChanged="chkAllSMS_OnCheckedChanged"/>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="chkSingleSMS" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <div>
                                ...
                                <asp:Button runat="server" ID="btn_Save" OnClick="btn_Save_OnClick" Text="Submit " CssClass="btn btn-sm btn-info" />     <div class="or or-sm"></div>
