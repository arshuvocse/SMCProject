...
public partial class Report_Pages_AttendanceReport : System.Web.UI.Page
{
            ...
            var response =
                await
                    _httpClient.GetStringAsync(
                        "http://182.160.103.237:8089/smclms/index.php/api/attendanceReport/index/" + EmployeeID + "/" +
                        date_form + "/" + date_to + "");
    ...
    {
        if (ddlCompany.SelectedIndex > 0 && ddlEmpInfo.SelectedIndex > 0 && txtCreatedDate.Text != "" && txtToDate.Text.Trim()!="") 
        {
      ...
      DataTable dtMain = aIncrementDal.LoadEmployeeInformationForDesignation(ddlEmpInfo.SelectedValue);
            ...
            await GetAttendanceData(ddlEmpInfo.SelectedValue, txtCreatedDate.Text.Trim(), txtToDate.Text.Trim());
        }
        else
    ...
    protected void loadGridView_OnRowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell.Text = "<p></p><p style='font-weight:bold!important'>" + com + "</p>" +
                              " <p>Employee Attendane Detail Report</p>" +
                              " <p>" + hfEmpName.Value + "</p>" +
                              " <p>" + hfDesig.Value + "</p>" +
                              " <p> Report Period: (" + txtCreatedDate.Text + " To " + txtToDate.Text + ")</p>" +
