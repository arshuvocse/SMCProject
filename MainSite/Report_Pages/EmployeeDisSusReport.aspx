<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="EmployeeDisSusReport.aspx.cs" Inherits="Report_Pages_EmployeeDisSusReport" %>
    ...
    <div class="content" id="content">
        ...
        <div class="page-heading">
            <div class="page-heading__container">
                <div class="icon"> </div>
                <span></span>
                <h1 class="title" style="font-size: 18px; padding-top: 9px;"><img src="app.png" width="18px" /> Disciplinary Action Report </h1>
            </div>
                                ...
                                <div class="col-md-2" runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="reportDropDownList" AutoPostBack="True" runat="server" class="form-control form-control-sm" OnSelectedIndexChanged="reportDropDownList_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem  Value="Diciplinary">Diciplinary Action List</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                        ...
                        <ContentTemplate>
                            <div id="gridContainer1"  style="overflow: scroll; height: 500px;width: 100%">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    ...
                                    OnRowCommand="loadGridView_RowCommand" OnRowCreated="loadGridView_OnRowCreated" AllowSorting="True">
                                    <Columns>
