...
public partial class Report_Pages_MPBudgetListReport : System.Web.UI.Page
{
    private static string _userId;
    private MPBudgetListReportDAL _commonDataLoad = new MPBudgetListReportDAL();
    ...
    private void LoadManpowerBudgetInfo()
    {
        ...
        if (ddlCompany.SelectedValue != "")
        {
            if (ddlDepartment.SelectedValue != "")
            {
                ...
                {
                    DataTable aTable = _commonDataLoad.GetManpowerBudgetListInfo(ddlCompany.SelectedValue, ddlDepartment.SelectedValue, ddlFinYear.SelectedValue, "  And bm.CompanyId IN (" + CompanyId() + ") AND bm.IsActive=1 ");
