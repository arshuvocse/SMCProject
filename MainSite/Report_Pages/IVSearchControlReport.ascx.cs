...
public partial class Report_Pages_IVSearchControlReport : System.Web.UI.UserControl
{
    ...
    private string parm()
    {
        ...
        if (ddlCompany.SelectedIndex > 0)
        {
            prm = prm + " and r.CompanyId =" + ddlCompany.SelectedValue;
        }
        if (ddlFinYear.SelectedIndex > 0)
        {
            prm = prm + " and r.FinYearId =" + ddlFinYear.SelectedValue;
        }
        if (ddlDepartment.SelectedIndex > 0)
        {
            prm = prm + " and r.DeptId =" + ddlDepartment.SelectedValue;
        }
        return prm;
    }
    ...
    protected void ddlDepartment_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (valdatioon())
        {
            ...
            {
                ddlJobCirculation.DataSource = dt;
                ddlJobCirculation.DataValueField = "Value";
                ddlJobCirculation.DataTextField = "TextField";
                ddlJobCirculation.DataBind();
            }
