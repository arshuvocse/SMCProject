...
public partial class Report_Pages_ContractRenewalReport : System.Web.UI.Page
{
    ShowMessage aShowMessage = new ShowMessage();
    ContractRenewalReportDal aReportDal = new ContractRenewalReportDal();
    ...
    private String IncrementGenerateParamiterList()
    {
        ...
        {
            parameter = parameter + " AND EPE.IsExtension = 1";
        }

        if (ExtentionRenewRadioButtonList.Items[1].Selected)
        {
            parameter = parameter + " AND EPE.IsRenew = 1";
        }

        if (ExtentionRenewRadioButtonList.Items[2].Selected)
        {
            parameter = parameter + " AND EPE.IsPermanentToContractual = 1";
        }

        if (ExtentionRenewRadioButtonList.Items[3].Selected)
        {
            parameter = parameter + " AND EPE.IsContractualToPermanent = 1";
        }
