...
public partial class Report_Pages_EmployeeInfoListReportGroup2 : System.Web.UI.Page
{
    ...
    private void LoadEMPInfo()
    {
        if (ddlCompany.SelectedIndex > 0)
        {
            ...
            jobCreationInfos = _userCommonDal.GetEMpInfosForGrupRewport_New(GenerateParameter() + " ", GenerateParameter_SP());
    ...
    private string GenerateParameter()
    {
        ...
        {
            if (empStatusDropDownList.SelectedValue == "Yes")
            {
                parameter = parameter + "  and    e.IsActive = 1";
            }
            if (empStatusDropDownList.SelectedValue == "No")
            {
                parameter = parameter + "  and    e.IsActive = 0";
            }
        }
