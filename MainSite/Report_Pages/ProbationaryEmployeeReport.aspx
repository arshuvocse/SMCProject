<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ProbationaryEmployeeReport.aspx.cs" Inherits="Report_Pages_ProbationaryEmployeeReport" %>
                    ...
                    <div class="card-body" style="background-color: white">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <fieldset class="for-panel">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group ">
                                                            <div class="form-group">
                                                                <label>Probation From Date</label>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <asp:LinkButton runat="server" ID="LinkButton1" OnClick="btn_Approve_OnClick" CssClass="btn btn-success btn-block"><span aria-hidden="true" class="fa fa-9x fa-check-circle"></span> Confirm Employee </asp:LinkButton>
                                    </div>
                                    <div class="col-md-8">
                                    </div>
                                    <div class="col-md-2">
