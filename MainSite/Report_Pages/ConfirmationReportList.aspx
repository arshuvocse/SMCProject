<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ConfirmationReportList.aspx.cs" Inherits="Report_Pages_ConfirmationReportList" %>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Conformation From Date</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Conformation To Date </label>
                                ...
                                <div style="overflow: scroll; height: 500px; width: 100%">
                                    <asp:GridView ID="gv_ProbationaryEmployee" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DateOfConformation" HeaderText="Date Of Conformation" DataFormatString="{0:dd-MMM-yyyy}" />                                           
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
