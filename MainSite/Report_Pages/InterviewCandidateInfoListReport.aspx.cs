...
public partial class Report_Pages_InterviewCandidateInfoListReport : System.Web.UI.Page
{
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
            ...
            if (loadGridView.Rows.Count > 0)
            {
                ...
                string headerTable = @"<span  style='text-align:left'><h3> List of Candidates for the position of " + ddlJobCirculation.SelectedItem.Text +
                                     "</h3>  ";
