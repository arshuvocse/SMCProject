...
public partial class Report_Pages_ProbationListReport : System.Web.UI.Page
{
    ...
    ProbationListReportDAL aDal = new ProbationListReportDAL();
    ...
    private void LoadManpowerBudgetInfo()
    {
        ...
        DataTable dtdata2 = aDal.GetJdByMasterByCom(ddlCompany.SelectedValue);
    ...
    public string Parameter()
    {
        ...
        if (ddlCompany.SelectedIndex>0)
        {
            ...
            param = param + " AND Emp.CompanyId='" + ddlCompany.SelectedValue + "' ";
        }
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //        //string did = datKey["MPBudgetDetailsId"].ToString();
        //        //Session["Status"] = "Edit";
        //        Response.Redirect("ProbationEvaluationForm.aspx?id=" + loadGridView.DataKeys[rowindex][0].ToString());
        //        //+ "&mdid=" + loadGridView.DataKeys[rowindex][1].ToString());    
    ...
    protected void btn_edit_OnClick(object sender, EventArgs e)
    {
        ...
        HiddenField mastrId = (HiddenField)loadGridView.Rows[rowID].FindControl("ProbationEvaluationMasterId");
    ...
    {
        string url = "../Report_UI/ProbationListReportViwer.aspx?rptType=" + mastrId;
