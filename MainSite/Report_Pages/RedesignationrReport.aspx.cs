...
public partial class Report_Pages_RedesignationrReport : System.Web.UI.Page
{
    ShowMessage aShowMessage = new ShowMessage();
    RedesignationReportDal aReportDal = new RedesignationReportDal();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            LoadHeierchicalTree();
            TreeViewredesignation.CollapseAll();
        }
    }
    ...
    {
        Response.Redirect("RedesignationrReport.aspx");
    }
