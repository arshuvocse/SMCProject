<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="TransferInfoReport.aspx.cs" Inherits="Report_Pages_TransferInfoReport" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <br />
                                 <div class="row">
                                    <div class="col-md-2">
                                        <asp:LinkButton runat="server" ID="LinkButton3" OnClick="btn_Approve_OnClick" CssClass="btn btn-success btn-block"><span aria-hidden="true" class="fa fa-9x fa-check-circle"></span> Confirm Transfer </asp:LinkButton>
                                    </div>
                                    <div class="col-md-8">
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div style="overflow: scroll; height: 400px; width: 100%">
                                    <asp:GridView ID="gv_ProbationaryEmployee" runat="server" AutoGenerateColumns="False"
                                        CssClass="table table-bordered  text-center thead-light" DataKeyNames="EmpInfoId,Status,NewJobLocationId,NewSalaryLocationId" PageIndex="0">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Location" HeaderText="Place of posting" />
