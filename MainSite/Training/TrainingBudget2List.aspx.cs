...
public partial class Training_TrainingBudget2List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            gv_trainingBgtList.UseAccessibleHeader = true;
            gv_trainingBgtList.HeaderRow.TableSection = TableRowSection.TableHeader;
            gv_trainingBgtList.FooterRow.TableSection = TableRowSection.TableFooter;
        }
        catch (Exception)
        {
    ...
    {
        DataTable dt = aTrainingDal.TrainingBudget2List(Parameter());
