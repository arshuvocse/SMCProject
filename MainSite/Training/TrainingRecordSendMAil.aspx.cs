...
public partial class Training_TrainingRecordSendMAil : System.Web.UI.Page
{
    private int mid = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["mid"]))
            {
                ...
                DataTable empGrd = _recordDal.GetTrainingRecordFroSendMail(mid);
        ...
        if (txtMailBody.Text!="")
        {
            try
            {
                ...
                for (int i = 0; i < gv_selectedEmp.Rows.Count; i++)
                {
                    ...
                    Label txt_ReportingEmail = (Label)gv_selectedEmp.Rows[i].Cells[1].FindControl("txt_ReportingEmail");
                    ...
                    try
                    {
                        mail.To.Add(EmpMail.Text.Trim() + " , " + txt_ReportingEmail.Text.Trim());
                    }
                    catch (Exception)
                    {
                    ...
                    mail.Subject = "Training Invitation";
                 ...
                 "alert",
                 "alert('Sent Successfully...! ');window.location ='TrainingRecords.aspx';",
                 true);
