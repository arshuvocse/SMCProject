...
public partial class Training_TrainingBudget2List : System.Web.UI.Page
{
    ...
    {
        DataTable dt = aTrainingDal.TrainingBudget2ListApp();
        ...
        //    gv_trainingBgtList.DataSource = null;
        //    gv_trainingBgtList.DataBind();
        //}
    ...
    protected void lb_Edit_OnClick(object sender, EventArgs e)
    {
        ...
        HiddenField hdpk = (HiddenField)gv_trainingBgtList.Rows[rowindex].FindControl("hdpk");

        //int rowindex = Convert.ToInt32(e.CommandArgument);


        var datKey = gv_trainingBgtList.DataKeys[rowindex];
        if (datKey != null)
        {
            ...
            Session["TrainingBudget2Id"] = "";
            Session["TrainingBudget2Id"] = jobReqId;
        ...
        Response.Redirect("TrainingBudget2App.aspx?mid=" + gv_trainingBgtList.DataKeys[rowindex][0].ToString());
    }
