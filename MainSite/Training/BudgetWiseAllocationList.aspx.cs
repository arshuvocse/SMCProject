...
public partial class Training_BudgetWiseAllocationList : System.Web.UI.Page
{
    ...
    {
        DataTable dt = _trainingDal.GetBudgetAlloationList();
    ...
    protected void lb_Edit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("BudgetWiseAllocation.aspx?mid=" + hdpk.Value);
    }
    protected void lb_remove_Click(object sender, EventArgs e)
    {
        ...
        bool result = _trainingDal.DeleteTrainingBudgetWiseAllocation(Convert.ToInt32(hdpk.Value), Session["LoginName"].ToString());
    ...
    protected void btnbgtWiseAllocation_OnClick(object sender, EventArgs e)
    {
