<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" EnableViewState="true" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="TrainingRecords.aspx.cs" Inherits="Training_TrainingRecords" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid">
                        ...
                        <div class="page-heading__container">
                            <h1 class="title" style="font-size: 18px; padding-top: 0px;"> <img src="../Report_Pages/app.png"  width="20px" /> Training Records</h1>
                        </div>
                        <div class="page-heading__container float-right d-none d-sm-block">
                               <asp:LinkButton ID="HomeButton" style="font-style: normal!important; font-weight: bold" CssClass="btn btn-sm btn-outline-secondary " runat="server"  OnClick="homeButton_OnClick"><i class="fa fa-home"></i>&nbsp; Home</asp:LinkButton>
                     
                             <asp:LinkButton ID="btnAddNewTraining"  style="font-style: normal!important; font-weight: bold"   CssClass="btn btn-sm btn-outline-success " runat="server" OnClick="btnAddNewTraining_OnClick" > <i class="fa fa-plus"></i>&nbsp;Add New</asp:LinkButton>
              ...
              var table = $('#cpFormBody_gv_trainingList').DataTable(
                   {
                    ...
                    ,
                           filename: 'Training Records List',
                           title: 'SMC',
                           messageTop: 'Training Records List',
                           exportOptions: {
           ...
           .table   thead th {
              ...
              background-color: #880e4f !important;
                        ...
                        <div class="card-body">
                            ...
                            <asp:GridView ID="gv_trainingList" runat="server"  AutoGenerateColumns="false"         CssClass="AddToListCssTable"  OnPreRender="gv_DocumentUpload_PreRender" >
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SL#">
                                     ...
                                     <asp:TemplateField HeaderText="Send Mail">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lb_SendMail" OnClick="lb_SendMail_OnClick" runat="server"><img src="../Assets/img/email-1.png" width="20px"  /></asp:LinkButton>
                                    ...
                                    <asp:TemplateField HeaderText="Type ">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_type" runat="server"  Text='<%#Eval("TrainingType") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Training Number">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Numer" runat="server"   Text='<%#Eval("TrainingRecordNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Training Orgaization ">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Torg" runat="server"   Text='<%#Eval("TrainingOrgName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lb_remove" OnClick="lb_remove_OnClick" runat="server"><img src="../Assets/img/delete.png"/></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
