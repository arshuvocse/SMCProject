...
public partial class Training_VenueList : System.Web.UI.Page
{
    ...
    {
        DataTable dt = aVenueDal.GetAreaInformation();
    ...
    protected void lb_Edit_Click(object sender, EventArgs e)
    {
        ...
        Session["Status"] = "Edit";
        Session["SMCVenueID"] = hdpk.Value;
        Response.Redirect("VenueEntry.aspx");
    }
    ...
    protected void lb_remove_Click(object sender, EventArgs e)
    {
        ...
        //bool result = aVenueDal.DeleteAreaInfoById(hdpk.Value);
