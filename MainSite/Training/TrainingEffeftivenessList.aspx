<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainMasterPage.master" CodeFile="TrainingEffeftivenessList.aspx.cs" Inherits="Training_TrainingEffeftivenessList" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-heading"  >
                    <div class="page-heading__container">
                        <div class="icon"></div>
                        <span></span>
                        <h1 class="title" style="font-size: 16px; padding-top: 1px;"><img src="../Report_Pages/app.png" width="20px"  />Training Effeftiveness Information </h1>
                    </div>
                         ...
                         var table = $('#cpFormBody_loadGridView').DataTable(
                              {
                               ...
                               ,
                                      filename: 'Training Effeftiveness Information List',
                                      title: 'SMC',
                                      messageTop: 'Training Effeftiveness Information List',
                                      exportOptions: {
                                          columns: [0, 1, 2, 3]
                                      }
                                  }
           ...
           .table   thead th {
              ...
              background-color: #880e4f !important;
                                ...
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                    CssClass="table table-bordered  text-center thead-light" DataKeyNames="TrainingRecordMasterId"
                                    OnRowCommand="loadGridView_RowCommand">
                                    <Columns>
                                      <asp:TemplateField HeaderText="SL#">
                                                <ItemTemplate>
                                                    <%#Container.DataItemIndex+1 %>
                                                        <asp:HiddenField runat="server" ID="HDEmpID" Value='<%#Eval("EmpInfoId") %>'/>
                                         ...
                                         <asp:TemplateField HeaderText="Participant">
                                              ...
                                              <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDownload" runat="server" CommandArgument="<%# Container.DataItemIndex %>" CommandName="Evaluate" backcolor="#0069D9" borderstyle="None" CssClass="btn btn-info btn-sm"> Evaluate  &gt; &gt; &gt; &gt; </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
