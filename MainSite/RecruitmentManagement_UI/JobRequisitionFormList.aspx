<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="JobRequisitionFormList.aspx.cs" Inherits="RecruitmentManagement_UI_JobRequisitionFormList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpFormBody" runat="Server">
    ...
    <script>
        function printDiv() {
            var divContents = document.getElementById("sssssss").innerHTML;
            var a = window.open('', '', 'height=500, width=500');
            a.document.write('<html>');
            a.document.write('<body > <h2>Employee Requisition Form  <br>');
    ...
    <div class="content" id="content">
        ...
        <div class="page-heading">
            <div class="page-heading__container">
                <span></span>
                <h1 class="title" style="font-size: 18px; padding-top: 1px;">Employee Requisition Form </h1>
            </div>
            ...
            <div class="page-heading__container float-right d-none d-sm-block">
                <input type="button" style="display: none" value="click" onclick="printDiv()">
        ...
        <div class="container-fluid" id="sssssss">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td> <asp:Label ID="lblSFrom" runat="server"></asp:Label></td>
                                               
                                                    
                                                      <td style="width: 30%; padding: 10px;">Salary Range To</td>
                                        <td> <asp:Label ID="lblSTo" runat="server"></asp:Label></td>
                                                    </table>
                                                  </div>
                                        </td>
