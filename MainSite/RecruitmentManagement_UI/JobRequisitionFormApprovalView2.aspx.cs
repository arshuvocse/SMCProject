...
public partial class MasterSetup_UI_JobRequisitionForm : System.Web.UI.Page
{
   ...
   Messages aMessages = new Messages();
    ...
    private void DataLoadByCondition(string pageName, string user)
    {
        ...
        RadItemRemove();
        //DataTable dt = _aFincDal.GetSelfAppraisalListApprove(ActionStatus);
    ...
    public void LoadData(string id)
    {
        ...
        if (dtdata.Rows.Count > 0)
        {
            ...
            lblFinYear.Text = financialYearDropDownList.SelectedItem.Text;
            ...
            lblreqDate.Text = reqDateTextBox.Text;
            ...
            lblJustification.Text = JustificationTextBox.Text;
            ...
            lblinternalCon.Text = internalConTextBox.Text;
            lblexternalCon.Text = externalConTextBox.Text;


            officeDropDownList.SelectedValue = dtdata.Rows[0]["OfficeId"].ToString();
            lblOffice.Text = officeDropDownList.SelectedItem.Text;
            ...
            if (officeDropDownList.SelectedValue != "")
            {
                ...
                lblJobLocation.Text = placeDropDownList.SelectedItem.Text;
            }
            else
            {
            ...
            lblgrade.Text = gradeDropDownList.SelectedItem.Text;
            ...
            if (Convert.ToBoolean(dtdata.Rows[0]["IsBudgeted"]) == true)
            {
                ...
                lblManagementApproved.Text = "Yes";
                ...
                lblBudgetedPosition.Text = BudgetCodeDropDownList.SelectedItem.Text;
           ...
           
            {
                ...
                ShowBudgetInfo.Visible = false;
                lblManagementApproved.Text = "No";
            }

            reportToTextBox.Text = dtdata.Rows[0]["ReportingTo"].ToString();
            lblreportTo.Text = reportToTextBox.Text;
           ...
           // isBudgetedCheckBox.Checked = Convert.ToBoolean(dtdata.Rows[0]["IsBudgeted"].ToString());
            ...
            lblDepartment.Text = deptDropDownList.SelectedItem.Text;
    ...
    public bool Validation()
    {
        ...
        //if (isBudgetedCheckBox.se )
        //{

        //    if (BudgetCodeDropDownList.SelectedValue == "")
        //    {
        //        ShowMessageBox("You have to select budget code !!!!");
        //        return false;
        //    }
        ...
        {
            ShowMessageBox("You have to select grade !!!!");
            return false;
        }
        ...
        if (count == 0)
        {
            ShowMessageBox("You have to select Employee Type !!!!");
            return false;
        }
        else
        {
            for (int i = 0; i < typeOfPosRadioButtonList.Items.Count; i++)
            {
                if (typeOfPosRadioButtonList.Items[i].Selected)
                {
                    if (typeOfPosRadioButtonList.Items[i].Text.Trim() == "Contractual")
                    {
                        ...
                        {
                            ShowMessageBox("You have to select a project !!!!");
                            return false;
                        }
                    }
                }
        ...
        if (officeDropDownList.SelectedValue == "")
        {
            ShowMessageBox("You have to select office !!!!");
            return false;
        }
        ...
        if (count1 == 0)
        {
            ShowMessageBox("Prefered way of circular isrequired !!!!");
            return false;
        }
        ...
        if (Validation())
        {
          ...
          //    aEmployeeRequsitionDao.IsBudgeted = isBudgetedCheckBox.Items;
            ...
            aEmployeeRequsitionDao.Justification = JustificationTextBox.Text;
                ...
                aEmployeeRequsitionDao.ActionStatus = "Drafted";
            ...
            if (id > 0)
            {
             ...
             //   EducationRequirementsDetailDao aDetailDao;
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('Data Saved Successfully...');window.location ='JobRequisitionFormView.aspx';",
                    true);
        ...
        if (Validation())
        {
          ...
          //  aEmployeeRequsitionDao.IsBudgeted = isBudgetedCheckBox.Checked;
            aEmployeeRequsitionDao.Remarks = RemarksTextBox.Text;
                ...
                //// =  isBudgetedCheckBox.Items[0].Text ;
                ////if (isBudgetedCheckBox.Items[0].Text.Trim() == "True")
                ////{
                ////    aEmployeeRequsitionDao.IsBudgeted=
                ////    isBudgetedCheckBox.Items[0].Selected = true;
                ////    //     aEmployeeRequsitionDao.BudgetId = Convert.ToInt32(BudgetCodeDropDownList.SelectedValue);
                ////    ShowBudgetInfo.Visible = true;
                  
                ////}
                ////else if (isBudgetedCheckBox.Items[i].Text.Trim() == "False")
                ////{
                ////    isBudgetedCheckBox.Items[i].Selected = true;
                ////}
    ...
    protected void Button2_OnClick(object sender, EventArgs e)
    {
        try
        {
            aEmployeeRequsitionDal.UpdateStatus(empIdHiddenField.Value,
                    jobreqRadioButtonList.SelectedValue, Session["UserId"].ToString(), DateTime.Now);
            //DataLo ad();
            JobReqAppLogDAO appLogDao = new JobReqAppLogDAO()
            {
                ActionStatus = jobreqRadioButtonList.SelectedValue,
            ...
            int id = aEmployeeRequsitionDal.SaveJobReqAppLog(appLogDao);
            ScriptManager.RegisterStartupScript(this, this.GetType(),
                    "alert",
                    "alert('" + jobreqRadioButtonList.SelectedItem.Text + " Successfully Done');window.location ='MPBudgetListApproval.aspx';",
                    true);
    ...
    protected void EmployeeNameTextBox_OnTextChanged(object sender, EventArgs e)
    {
        ...
        if (empName.Contains(':'))
        {
            ...
            if (dtdata.Rows.Count>0)
            {
             ...
             //  salgradLabel.Text = "Department: " + dtdata.Rows[0]["DepartmentName"].ToString();
                divLabel.Text = dtdata.Rows[0]["DivisionName"].ToString();
                wingLabel.Text =  dtdata.Rows[0]["EmpType"].ToString();
               // wingLabel.Text = dtdata.Rows[0]["EmpType"].ToString();
                deptLabel.Text =  dtdata.Rows[0]["DepartmentName"].ToString();
    ...
    protected void BudgetCodeDropDownList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (dtdata.Rows.Count > 0)
        {
            ...
            lblJobSummary.Text = descriptionTextBox.Text;
            ...
            for (int i = 0; i < typeOfPosRadioButtonList.Items.Count; i++)
            {
                ...
                {
                    typeOfPosRadioButtonList.Items[i].Selected = true;
                    lblEmpType.Text = typeOfPosRadioButtonList.SelectedItem.Text;
                }
                ...
                if (typeOfPosRadioButtonList.Items[i].Selected)
                {
                    if (typeOfPosRadioButtonList.Items[i].Text.Trim() == "Contractual")
                    {
                        ...
                        lblProject.Text = projectDropDownList.SelectedItem.Text;
                    }
                }
            }
